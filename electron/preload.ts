...
contextBridge.exposeInMainWorld('api', {
  ...
  moverReserva: (d: any) => invokeSafe('reservas:mover', d),
  actualizarEstadoReserva: (d: any) => invokeSafe('reservas:estado', d),
  actualizarReserva: (d: any) => invokeSafe('reservas:actualizar', d),
