...
function dt() {
  ...
  ie = 1;
  const E = Ct, t = Dt, e = St, _ = wE, T = Ut.version, a = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
  function n(h) {
    const L = {};
    let U = h.toString();
    U = U.replace(/\r\n?/mg, `
...
`), G = G.replace(/\\r/g, "\r")), L[F] = G;
  ...
  function c(h) {
    return h[0] === "~" ? t.join(e.homedir(), h.slice(1)) : h;
  }
  function s(h) {
  ...
  function C(h) {
    ...
    const L = S(h);
    return L ? M._configVault(h) : (R(`You set DOTENV_KEY but you are missing a .env.vault file at ${L}. Did you forget to build it?`), M.configDotenv(h));
  }
  function D(h, L) {
...
function Gt() {
  ...
  return __ = function(e) {
    const _ = e.reduce(function(A, T) {
      const a = T.match(E);
      return a && (A[a[1]] = a[2]), A;
    }, {});
  ...
  return ae || (ae = 1, (function(E) {
    ...
    t.escapeId = function(i, I) {
      if (Array.isArray(i)) {
        ...
        return u;
      } else return I ? "`" + String(i).replace(e, "``") + "`" : "`" + String(i).replace(e, "``").replace(_, "`.`") + "`";
      ...
      var M = n(O, 4) + "-" + n(S, 2) + "-" + n(c, 2) + " " + n(s, 2) + ":" + n(r, 2) + ":" + n(C, 2) + "." + n(D, 3);
      return a(M);
    ...
    function a(R) {
      for (var i = A.lastIndex = 0, I = "", u; u = A.exec(R); )
        I += R.slice(i, u.index) + T[u[0]], i = A.lastIndex;
      return i === 0 ? "'" + R + "'" : i < R.length ? "'" + I + R.slice(i) + "'" : "'" + I + "'";
    }
    function n(R, i) {
      for (R = R.toString(); R.length < i; )
        R = "0" + R;
      return R;
    }
    function N(R) {
...
function ZE() {
  ...
  const E = (t) => {
    ...
    let _ = 0, A = 0, T = 0, a = [];
    const { onEviction: n } = t, N = /* @__PURE__ */ new Map(), R = new Array(e).fill(void 0), i = new Array(e).fill(void 0), I = new Array(e).fill(0), u = new Array(e).fill(0), O = (r) => {
      I[T] = r, u[r] = T, I[r] = 0, T = r;
    }, S = (r) => {
      if (r === T)
        return;
      const C = I[r], D = u[r];
      r === A ? A = C : I[D] = C, u[C] = D, O(r);
    }, c = (r) => {
      let C = T;
      const D = Math.min(_, r), B = _ - D, M = new Array(D), h = new Array(D);
      for (let L = 0; L < B; L++) {
        const U = R[A];
        n == null || n(U, i[A]), N.delete(U), A = I[A];
      }
      for (let L = D - 1; L >= 0; L--)
        M[L] = R[C], h[L] = i[C], N.set(R[C], L), C = u[C];
      A = 0, T = D - 1, _ = D, R.length = r, i.length = r, I.length = r, u.length = r;
      for (let L = 0; L < D; L++)
        R[L] = M[L], i[L] = h[L], I[L] = L + 1, u[L] = L - 1;
      a = [];
      for (let L = D; L < r; L++)
        a.push(L);
    }, s = (r) => {
      R.length = r, i.length = r, I.length = r, u.length = r, R.fill(void 0, e), i.fill(void 0, e), I.fill(0, e), u.fill(0, e);
    };
    return {
      ...
      set(r, C) {
        ...
        if (D === void 0) {
          if (_ === e) {
            D = A;
            const B = R[D];
            n == null || n(B, i[D]), N.delete(B), A = I[D], u[A] = 0;
          } else
            D = a.length > 0 ? a.pop() : _, _++;
          N.set(r, D), R[D] = r, i[D] = C, _ === 1 ? A = T = D : O(D);
        } else
          n == null || n(r, i[D]), i[D] = C, S(D);
      },
      ...
      *entries() {
      ...
      delete(r) {
        ...
        if (C === void 0)
          return !1;
        n == null || n(r, i[C]), N.delete(r), a.push(C), R[C] = void 0, i[C] = void 0;
        const D = u[C], B = I[C];
        return C === A ? A = B : I[D] = B, C === T ? T = D : u[B] = D, _--, !0;
      },
      ...
      evict: (r) => {
        ...
        for (; C > 0; ) {
          const D = A, B = R[D];
          n == null || n(B, i[D]), N.delete(B), R[D] = void 0, i[D] = void 0, A = I[D], u[A] = 0, _--, a.push(D), C--;
        }
        _ === 0 && (A = T = 0);
      },
      ...
      clear() {
        ...
        N.clear(), R.fill(void 0), i.fill(void 0), a = [], _ = 0, A = T = 0;
      },
...
function pn() {
  ...
  function _(a, n, N, R, i) {
    const I = e(a, n, N, R);
    let u = t.get(I);
    return u || (u = i(n, N, R), t.set(I, u), u);
  }
  function A(a) {
    t.resize(a);
  }
...
function VR() {
  ...
  return E.prototype.peekAt = function(e) {
    ...
    if (e !== this._head) {
      ...
      return this._list[this._tail] = void 0, this._head < 2 && e > 1e4 && e <= _ >>> 2 && this._shrinkArray(), A;
    }
    ...
    if (A === (A | 0) && this._head !== this._tail) {
      ...
      if (!(A >= n || A < -n || _ < 1)) {
        ...
        A + _ > n && (_ = n - A);
        var R;
        for (T = new Array(_), R = 0; R < _; R++)
          T[R] = this._list[this._head + A + R & this._capacityMask];
        if (A = this._head + A & this._capacityMask, e + _ === n) {
          for (this._tail = this._tail - _ + N & this._capacityMask, R = _; R > 0; R--)
            this._list[A = A + 1 + N & this._capacityMask] = void 0;
          return T;
        }
        if (e === 0) {
          for (this._head = this._head + _ + N & this._capacityMask, R = _ - 1; R > 0; R--)
            this._list[A = A + 1 + N & this._capacityMask] = void 0;
          return T;
        }
        if (A < n / 2) {
          for (this._head = this._head + e + _ + N & this._capacityMask, R = e; R > 0; R--)
            this.unshift(this._list[A = A - 1 + N & this._capacityMask]);
          for (A = this._head - 1 + N & this._capacityMask; a > 0; )
            this._list[A = A - 1 + N & this._capacityMask] = void 0, a--;
          e < 0 && (this._tail = A);
        } else {
          for (this._tail = A, A = A + _ + N & this._capacityMask, R = n - (_ + e); R > 0; R--)
            this.push(this._list[A++]);
          for (A = this._tail; a > 0; )
            this._list[A = A + 1 + N & this._capacityMask] = void 0, a--;
        }
    ...
    if (A === (A | 0)) {
      ...
      if (A < 0 && (A += T), !(A > T))
        if (arguments.length > 2) {
          var a, n, N, R = arguments.length, i = this._list.length, I = 2;
          if (!T || A < T / 2) {
            for (n = new Array(A), a = 0; a < A; a++)
              n[a] = this._list[this._head + a & this._capacityMask];
            for (_ === 0 ? (N = [], A > 0 && (this._head = this._head + A + i & this._capacityMask)) : (N = this.remove(A, _), this._head = this._head + A + i & this._capacityMask); R > I; )
              this.unshift(arguments[--R]);
            for (a = A; a > 0; a--)
              this.unshift(n[a - 1]);
          } else {
            n = new Array(T - (A + _));
            var u = n.length;
            for (a = 0; a < u; a++)
              n[a] = this._list[this._head + A + _ + a & this._capacityMask];
            for (_ === 0 ? (N = [], A != T && (this._tail = this._head + A + i & this._capacityMask)) : (N = this.remove(A, _), this._tail = this._tail - u + i & this._capacityMask); I < R; )
    ...
    var _ = e.length, A = this._nextPowerOf2(_);
    this._list = new Array(A), this._capacityMask = A - 1, this._tail = _;
    for (var T = 0; T < _; T++) this._list[T] = e[T];
  }, E.prototype._copyArray = function(e, _) {
    var A = this._list, T = A.length, a = this.length;
    if (_ = _ | a, _ == a && this._head < this._tail)
      return this._list.slice(this._head, this._tail);
    var n = new Array(_), N = 0, R;
    if (e || this._head > this._tail) {
      for (R = this._head; R < T; R++) n[N++] = A[R];
      for (R = 0; R < this._tail; R++) n[N++] = A[R];
    } else
      for (R = this._head; R < this._tail; R++) n[N++] = A[R];
    return n;
    ...
    var _ = Math.log(e) / Math.log(2), A = 1 << _ + 1;
    return Math.max(A, 4);
  }, i_ = E, i_;
}
var I_ = {}, se;
  ...
  return Ce || (Ce = 1, (function(E, t) {
    (function(e, _) {
      ...
      function(e) {
        ...
        function R(f, l) {
          var g, P, Y;
          return l ? (f >>>= 0, (Y = 0 <= f && f < 256) && (P = N[f], P) ? P : (g = I(f, 0, !0), Y && (N[f] = g), g)) : (f |= 0, (Y = -128 <= f && f < 128) && (P = n[f], P) ? P : (g = I(f, f < 0 ? -1 : 0, !1), Y && (n[f] = g), g));
        }
        A.fromInt = R;
        function i(f, l) {
        ...
        A.fromValue = S;
        var c = 65536, s = 1 << 24, r = c * c, C = r * r, D = C / 2, B = R(s), M = R(0);
        A.ZERO = M;
        var h = R(0, !0);
        A.UZERO = h;
        var L = R(1);
        ...
        o.toInt = function() {
          ...
          return $ += H + q, J += $ >>> 16, $ &= 65535, J += Y + EE, _E += J >>> 16, J &= 65535, _E += P + y, k += _E >>> 16, _E &= 65535, k += g + K, k &= 65535, I(J << 16 | $, k << 16 | _E, this.unsigned);
          ...
          return VE += K * k, $ += VE >>> 16, VE &= 65535, $ += H * k, J += $ >>> 16, $ &= 65535, $ += K * q, J += $ >>> 16, $ &= 65535, J += Y * k, _E += J >>> 16, J &= 65535, J += H * q, _E += J >>> 16, J &= 65535, J += K * EE, _E += J >>> 16, J &= 65535, _E += P * k + Y * q + H * EE + K * y, _E &= 65535, I($ << 16 | VE, _E << 16 | J, this.unsigned);
        ...
        }, A.fromBytes = function(l, g, P) {
          return P ? A.fromBytesLE(l, g) : A.fromBytesBE(l, g);
          ...
          return typeof l == "bigint" ? A.fromBigInt(l, g) : S(l, g);
        }, o.toBigInt = function() {
...
function rE() {
  if (De) return N_;
  De = 1;
  var E = FR, t = E.Buffer, e = {}, _;
  for (_ in E)
    E.hasOwnProperty(_) && (_ === "SlowBuffer" || _ === "Buffer" || (e[_] = E[_]));
  var A = e.Buffer = {};
  for (_ in t)
    t.hasOwnProperty(_) && (_ === "allocUnsafe" || _ === "allocUnsafeSlow" || (A[_] = t[_]));
  if (e.Buffer.prototype = t.prototype, (!A.from || A.from === Uint8Array.from) && (A.from = function(T, a, n) {
    if (typeof T == "number")
    ...
    return t(T, a, n);
  }), A.alloc || (A.alloc = function(T, a, n) {
    if (typeof T != "number")
      throw new TypeError('The "size" argument must be of type number. Received type ' + typeof T);
    if (T < 0 || T >= 2 * (1 << 30))
      throw new RangeError('The value "' + T + '" is invalid for option "size"');
    var N = t(T);
    return !a || a.length === 0 ? N.fill(0) : typeof n == "string" ? N.fill(a, n) : N.fill(a), N;
  }), !e.kStringMaxLength)
    try {
  ...
  }, e.kStringMaxLength && (e.constants.MAX_STRING_LENGTH = e.kStringMaxLength)), N_ = e, N_;
}
var mE = {}, Se;
function mt() {
  if (Se) return mE;
...
function Yt() {
  ...
  function t(R, i) {
    this.enc = R.encodingName, this.bomAware = R.bomAware, this.enc === "base64" ? this.encoder = T : this.enc === "utf8" ? this.encoder = N : this.enc === "cesu8" && (this.enc = "utf8", this.encoder = a, E.from("eda0bdedb2a9", "hex").toString() !== "💩" && (this.decoder = n, this.defaultCharUnicode = i.defaultCharUnicode));
  }
  t.prototype.encoder = A, t.prototype.decoder = _;
  var e = ht.StringDecoder;
  function _(R, i) {
    this.decoder = new e(i.enc);
  }
  _.prototype.write = function(R) {
    return E.isBuffer(R) || (R = E.from(R)), this.decoder.write(R);
  ...
  T.prototype.write = function(R) {
    R = this.prevStr + R;
    var i = R.length - R.length % 4;
    return this.prevStr = R.slice(i), R = R.slice(0, i), E.from(R, "base64");
  }, T.prototype.end = function() {
  ...
  a.prototype.write = function(R) {
    for (var i = E.alloc(R.length * 3), I = 0, u = 0; u < R.length; u++) {
  ...
  n.prototype.write = function(R) {
    for (var i = this.acc, I = this.contBytes, u = this.accBytes, O = "", S = 0; S < R.length; S++) {
      var c = R[S];
    ...
    var R = 0;
    return this.contBytes > 0 && (R += this.defaultCharUnicode), R;
  };
  function N(R, i) {
    this.highSurrogate = "";
  }
  return N.prototype.write = function(R) {
    if (this.highSurrogate && (R = this.highSurrogate + R, this.highSurrogate = ""), R.length > 0) {
      var i = R.charCodeAt(R.length - 1);
      i >= 55296 && i < 56320 && (this.highSurrogate = R[R.length - 1], R = R.slice(0, R.length - 1));
    }
    return E.from(R, this.enc);
  }, N.prototype.end = function() {
    if (this.highSurrogate) {
      var R = this.highSurrogate;
      return this.highSurrogate = "", E.from(R, this.enc);
    }
  }, r_;
}
var NE = {}, Me;
function Wt() {
  ...
  NE._utf32 = t;
  function t(R, i) {
    this.iconv = i, this.bomAware = !0, this.isLE = R.isLE;
  }
  NE.utf32le = { type: "_utf32", isLE: !0 }, NE.utf32be = { type: "_utf32", isLE: !1 }, NE.ucs4le = "utf32le", NE.ucs4be = "utf32be", t.prototype.encoder = e, t.prototype.decoder = _;
  function e(R, i) {
    this.isLE = i.isLE, this.highSurrogate = 0;
  }
  e.prototype.write = function(R) {
    for (var i = E.from(R, "ucs2"), I = E.alloc(i.length * 2), u = this.isLE ? I.writeUInt32LE : I.writeUInt32BE, O = 0, S = 0; S < i.length; S += 2) {
  ...
  _.prototype.write = function(R) {
    if (R.length === 0)
      return "";
    var i = 0, I = 0, u = E.alloc(R.length + 4), O = 0, S = this.isLE, c = this.overflow, s = this.badChar;
    if (c.length > 0) {
      for (; i < R.length && c.length < 4; i++)
        c.push(R[i]);
      c.length === 4 && (S ? I = c[i] | c[i + 1] << 8 | c[i + 2] << 16 | c[i + 3] << 24 : I = c[i + 3] | c[i + 2] << 8 | c[i + 1] << 16 | c[i] << 24, c.length = 0, O = A(u, O, I, s));
    }
    for (; i < R.length - 3; i += 4)
      S ? I = R[i] | R[i + 1] << 8 | R[i + 2] << 16 | R[i + 3] << 24 : I = R[i + 3] | R[i + 2] << 8 | R[i + 1] << 16 | R[i] << 24, O = A(u, O, I, s);
    for (; i < R.length; i++)
      c.push(R[i]);
  ...
  T.prototype.encoder = a, T.prototype.decoder = n;
  function a(R, i) {
    R = R || {}, R.addBOM === void 0 && (R.addBOM = !0), this.encoder = i.iconv.getEncoder(R.defaultEncoding || "utf-32le", R);
  }
  a.prototype.write = function(R) {
  ...
  function n(R, i) {
    this.decoder = null, this.initialBufs = [], this.initialBufsLen = 0, this.options = R || {}, this.iconv = i.iconv;
  }
  n.prototype.write = function(R) {
    if (!this.decoder) {
    ...
    if (!this.decoder) {
      var R = N(this.initialBufs, this.options.defaultEncoding);
  ...
  function N(R, i) {
    ...
    E:
      for (var r = 0; r < R.length; r++)
        for (var C = R[r], D = 0; D < C.length; D++)
...
function Ht() {
  ...
  t.prototype.encoder = e, t.prototype.decoder = _, t.prototype.bomAware = !0;
  function e() {
  }
  e.prototype.write = function(N) {
    for (var R = E.from(N, "ucs2"), i = 0; i < R.length; i += 2) {
      var I = R[i];
      R[i] = R[i + 1], R[i + 1] = I;
    }
    return R;
  ...
  _.prototype.write = function(N) {
    if (N.length == 0)
      return "";
    var R = E.alloc(N.length + 1), i = 0, I = 0;
    for (this.overflowByte !== -1 && (R[0] = N[0], R[1] = this.overflowByte, i = 1, I = 2); i < N.length - 1; i += 2, I += 2)
      R[I] = N[i + 1], R[I + 1] = N[i];
    return this.overflowByte = i == N.length - 1 ? N[N.length - 1] : -1, R.slice(0, I).toString("ucs2");
  }, _.prototype.end = function() {
    this.overflowByte = -1;
  }, YE.utf16 = A;
  function A(N, R) {
  ...
  A.prototype.encoder = T, A.prototype.decoder = a;
  function T(N, R) {
    N = N || {}, N.addBOM === void 0 && (N.addBOM = !0), this.encoder = R.iconv.getEncoder("utf-16le", N);
  }
  ...
  function a(N, R) {
    this.decoder = null, this.initialBufs = [], this.initialBufsLen = 0, this.options = N || {}, this.iconv = R.iconv;
  }
  a.prototype.write = function(N) {
    ...
    if (!this.decoder) {
      ...
      return I && (R += I), this.initialBufs.length = this.initialBufsLen = 0, R;
    }
    return this.decoder.end();
  };
  function n(N, R) {
    ...
    return O > u ? "utf-16be" : O < u ? "utf-16le" : R || "utf-16le";
  }
  return YE;
}
var fE = {}, Le;
function vt() {
  ...
  t.prototype.encoder = _, t.prototype.decoder = A, t.prototype.bomAware = !0;
  var e = /[^A-Za-z0-9'\(\),-\.\/:\? \n\r\t]+/g;
  function _(c, s) {
    this.iconv = s.iconv;
  }
  _.prototype.write = function(c) {
    return E.from(c.replace(e, (function(s) {
  ...
  for (var T = /[A-Za-z0-9\/+]/, a = [], n = 0; n < 256; n++)
    a[n] = T.test(String.fromCharCode(n));
  var N = 43, R = 45, i = 38;
  ...
  u.prototype.write = function(c) {
    for (var s = this.inBase64, r = this.base64Accum, C = this.base64AccumIdx, D = E.alloc(c.length * 5 + 10), B = 0, M = 0; M < c.length; M++) {
      ...
      h >= 32 && h <= 126 ? (s && (C > 0 && (B += D.write(r.slice(0, C).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), B), C = 0), D[B++] = R, s = !1), s || (D[B++] = h, h === i && (D[B++] = R))) : (s || (D[B++] = i, s = !0), s && (r[C++] = h >> 8, r[C++] = h & 255, C == r.length && (B += D.write(r.toString("base64").replace(/\//g, ","), B), C = 0)));
    }
    return this.inBase64 = s, this.base64AccumIdx = C, D.slice(0, B);
  }, u.prototype.end = function() {
    var c = E.alloc(10), s = 0;
    return this.inBase64 && (this.base64AccumIdx > 0 && (s += c.write(this.base64Accum.slice(0, this.base64AccumIdx).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), s), this.base64AccumIdx = 0), c[s++] = R, this.inBase64 = !1), c.slice(0, s);
  };
  function O(c, s) {
    this.iconv = s.iconv, this.inBase64 = !1, this.base64Accum = "";
  }
...
function yt() {
  ...
  function t(A, T) {
    ...
    if (A.chars.length === 128) {
      for (var a = "", n = 0; n < 128; n++)
        a += String.fromCharCode(n);
      A.chars = a + A.chars;
    }
    this.decodeBuf = E.from(A.chars, "ucs2");
    for (var N = E.alloc(65536, T.defaultCharSingleByte.charCodeAt(0)), n = 0; n < A.chars.length; n++)
      N[A.chars.charCodeAt(n)] = n;
    this.encodeBuf = N;
  }
  t.prototype.encoder = e, t.prototype.decoder = _;
  function e(A, T) {
    this.encodeBuf = T.encodeBuf;
  }
  e.prototype.write = function(A) {
    for (var T = E.alloc(A.length), a = 0; a < A.length; a++)
      T[a] = this.encodeBuf[A.charCodeAt(a)];
    return T;
  }, e.prototype.end = function() {
  };
  function _(A, T) {
  ...
  return _.prototype.write = function(A) {
    for (var T = this.decodeBuf, a = E.alloc(A.length * 2), n = 0, N = 0, R = 0; R < A.length; R++)
      n = A[R] * 2, N = R * 2, a[N] = T[n], a[N + 1] = T[n + 1];
...
function jt() {
  ...
  var E = rE().Buffer;
  s_._dbcs = N;
  for (var t = -1, e = -2, _ = -10, A = -1e3, T = new Array(256), a = -1, n = 0; n < 256; n++)
    T[n] = t;
  function N(u, O) {
    ...
    if (typeof u.gb18030 == "function") {
      ...
      for (var C = this.decodeTables[0], c = 129; c <= 254; c++)
        for (var D = this.decodeTables[A - C[c]], B = 48; B <= 57; B++) {
          if (D[B] === t)
            D[B] = A - s;
          else if (D[B] > A)
            throw new Error("gb18030 decode tables conflict at byte 2");
          for (var M = this.decodeTables[A - D[B]], h = 129; h <= 254; h++) {
            if (M[h] === t)
              M[h] = A - r;
            else {
              if (M[h] === A - r)
            ...
            for (var L = this.decodeTables[A - M[h]], U = 48; U <= 57; U++)
              L[U] === t && (L[U] = e);
          }
        }
    }
  ...
  N.prototype.encoder = R, N.prototype.decoder = i, N.prototype._getDecodeTrieNode = function(u) {
    for (var O = []; u > 0; u >>>= 8)
      O.push(u & 255);
    O.length == 0 && O.push(0);
    for (var S = this.decodeTables[0], c = O.length - 1; c > 0; c--) {
      var s = S[O[c]];
      if (s == t)
        S[O[c]] = A - this.decodeTables.length, this.decodeTables.push(S = T.slice(0));
      else if (s <= A)
        S = this.decodeTables[A - s];
      else
...
function _i() {
  ...
  return S_ = function(t) {
    var e = t.Transform;
    function _(T, a) {
      this.conv = T, a = a || {}, a.decodeStrings = !1, e.call(this, a);
    }
    _.prototype = Object.create(e.prototype, {
      constructor: { value: _ }
    }), _.prototype._transform = function(T, a, n) {
      if (typeof T != "string")
      ...
      var a = [];
      return this.on("error", T), this.on("data", function(n) {
        a.push(n);
    ...
    function A(T, a) {
      this.conv = T, a = a || {}, a.encoding = this.encoding = "utf8", e.call(this, a);
    }
    return A.prototype = Object.create(e.prototype, {
      constructor: { value: A }
    }), A.prototype._transform = function(T, a, n) {
...
function ni() {
  return Pe || (Pe = 1, (function(E) {
    var t = rE().Buffer, e = mt(), _ = mR();
    E.exports.encodings = null, E.exports.defaultCharUnicode = "�", E.exports.defaultCharSingleByte = "?", E.exports.encode = function(a, n, N) {
      a = "" + (a || "");
      var R = E.exports.getEncoder(n, N), i = R.write(a), I = R.end();
      return I && I.length > 0 ? t.concat([i, I]) : i;
    }, E.exports.decode = function(a, n, N) {
      ...
      var R = E.exports.getDecoder(n, N), i = R.write(a), I = R.end();
      return I ? i + I : i;
      ...
      for (var N = E.exports._canonicalizeEncoding(a), R = {}; ; ) {
        ...
        switch (typeof I) {
          ...
          case "object":
            for (var u in I)
              R[u] = I[u];
            R.encodingName || (R.encodingName = N), N = I.type;
            break;
          case "function":
            return R.encodingName || (R.encodingName = N), i = new I(R, E.exports), E.exports._codecDataCache[R.encodingName] = i, i;
          default:
    ...
    }, E.exports.getEncoder = function(a, n) {
      var N = E.exports.getCodec(a), R = new N.encoder(n, N);
      return N.bomAware && n && n.addBOM && (R = new e.PrependBOM(R, n)), R;
    }, E.exports.getDecoder = function(a, n) {
      var N = E.exports.getCodec(a), R = new N.decoder(n, N);
      return N.bomAware && !(n && n.stripBOM === !1) && (R = new e.StripBOM(R, n)), R;
    }, E.exports.enableStreamingAPI = function(a) {
      if (!E.exports.supportsStreams) {
        var n = _i()(a);
        E.exports.IconvLiteEncoderStream = n.IconvLiteEncoderStream, E.exports.IconvLiteDecoderStream = n.IconvLiteDecoderStream, E.exports.encodeStream = function(R, i) {
          return new E.exports.IconvLiteEncoderStream(E.exports.getEncoder(R, i), i);
        }, E.exports.decodeStream = function(R, i) {
          return new E.exports.IconvLiteDecoderStream(E.exports.getDecoder(R, i), i);
...
function qE() {
  if (Ve) return bE;
  Ve = 1;
  const E = ni(), { createLRU: t } = ZE(), e = t({
    max: 500
  });
  return bE.decode = function(_, A, T, a, n) {
    if (Buffer.isEncoding(A))
      return _.toString(A, T, a);
    let N;
    if (!n)
      N = e.get(A), N || (N = E.getDecoder(A), e.set(A, N));
    else {
      const I = { encoding: A, options: n }, u = JSON.stringify(I);
      N = e.get(u), N || (N = E.getDecoder(I.encoding, I.options), e.set(u, N));
    }
    const R = N.write(_.slice(T, a)), i = N.end();
    return i ? R + i : R;
  }, bE.encode = function(_, A, T) {
    if (Buffer.isEncoding(A))
      return Buffer.from(_, A);
    const a = E.getEncoder(A, T || {}), n = a.write(_), N = a.end();
...
function X() {
  if (me) return B_;
  me = 1;
  const E = bR(), t = FR.Buffer, e = bt(), _ = qE(), A = TE(), T = /* @__PURE__ */ new Date(NaN), a = "000000000000";
  function n(S, c) {
    const s = c.toString();
    return s.length >= S ? s : (a + s).slice(-S);
  }
  const N = 45, R = 43, i = 46, I = 101, u = 69;
  class O {
    constructor(c, s, r, C) {
    ...
    readInt64JSNumber() {
      ...
      return new e(c, s, !0).toNumber();
    }
    readSInt64JSNumber() {
      const c = this.readInt32(), s = this.readInt32();
      return s & 2147483648 ? new e(c, s, !1).toNumber() : c + 4294967296 * s;
    }
    readInt64String() {
      const c = this.readInt32(), s = this.readInt32();
      return new e(c, s, !0).toString();
    }
    readSInt64String() {
      const c = this.readInt32(), s = this.readInt32();
      return new e(c, s, !1).toString();
    }
    readInt64() {
      const c = this.readInt32(), s = this.readInt32();
      let r = new e(c, s, !0);
    ...
    readDateTimeString(c, s, r) {
      ...
      return C > 3 && (D = this.readInt16(), B = this.readInt8(), M = this.readInt8(), F = [n(4, D), n(2, B), n(2, M)].join("-")), C > 6 ? (h = this.readInt8(), L = this.readInt8(), U = this.readInt8(), F += `${s || " "}${[
        n(2, h),
        n(2, L),
        n(2, U)
      ].join(":")}`) : r === A.DATETIME && (F += " 00:00:00"), C > 10 && (d = this.readInt32(), F += ".", c && (d = n(6, d), d.length > c && (d = d.substring(0, c))), F += d), F;
    }
    ...
    readTimeString(c) {
      ...
      return s > 6 && (C = this.readInt32(), D = this.readInt8(), B = this.readInt8(), M = this.readInt8()), s > 10 && (h = this.readInt32()), c ? (D += C * 24, B += D * 60, M += B * 60, h += M * 1e3, h *= r, h) : (r === -1 ? "-" : "") + [n(2, C * 24 + D), n(2, B), n(2, M)].join(":") + (h ? `.${h}`.replace(/0+$/, "") : "");
    }
    ...
    parseInt(c, s) {
      ...
      for (this.buffer[this.offset] === R && this.offset++; this.offset < D; )
    ...
    parseIntNoBigCheck(c) {
      ...
      if (c === 0)
        return 0;
      for (this.buffer[this.offset] === N && (this.offset++, C = -1), this.buffer[this.offset] === R && this.offset++; this.offset < r; )
...
function YR() {
  ...
  function e(A, T) {
    const a = A[T], n = A[T + 1], N = A[T + 2];
    return n + N === 0 ? a : a + (n << 8) + (N << 16);
  }
  class _ {
    constructor(T, a) {
    ...
    _flushLargePacket4() {
      ...
      const a = Buffer.concat(this.largePacketParts), n = new E(this.firstPacketSequenceId, a, 0, a.length);
      this.largePacketParts.length = 0, n.numPackets = T, this.onPacket(n);
    }
    _flushLargePacket7() {
      const T = this.largePacketParts.length;
      ...
      const n = new E(this.firstPacketSequenceId, a, 0, a.length);
      n.numPackets = T, this.onPacket(n);
    }
    executeStart(T) {
      let a = 0;
      const n = T.length;
      for (; n - a >= 3; )
        if (this.length = e(T, a), n - a >= this.length + this.packetHeaderLength) {
          const N = T[a + 3];
          ...
          this.buffer = [T.slice(a + 3, n)], this.bufferLength = n - a - 3, this.execute = _.prototype.executePayload;
          return;
        }
      n - a > 0 && (this.headerLen = n - a, this.length = T[a], this.headerLen === 2 ? (this.length = T[a] + (T[a + 1] << 8), this.execute = _.prototype.executeHeader3) : this.execute = _.prototype.executeHeader2);
    }
    executePayload(T) {
      let a = 0;
      const n = T.length, N = this.length - this.bufferLength + this.packetHeaderLength - 3;
      if (n - a >= N) {
        const R = Buffer.allocUnsafe(this.length + this.packetHeaderLength);
        let i = 3;
        for (let u = 0; u < this.buffer.length; ++u)
          this.buffer[u].copy(R, i), i += this.buffer[u].length;
        T.copy(R, i, a, a + N);
        const I = R[3];
        ...
        ), this.length < t && this._flushLargePacket()), this.buffer = [], this.bufferLength = 0, this.execute = _.prototype.executeStart, a += N, n - a > 0)
          return this.execute(T.slice(a, n));
      } else
...
function ei() {
  ...
  class t {
    ...
    toPacket(_) {
      const A = 6 + this.pluginName.length + this.pluginData.length, T = Buffer.allocUnsafe(A), a = new E(0, T, 0, A);
    ...
    static fromPacket(_, A) {
      _.readInt8();
      const T = _.readNullTerminatedString(A), a = _.readBuffer();
      return new t({
        pluginName: T,
        pluginData: a
      });
...
function ii() {
  if (Xe) return f_;
  Xe = 1;
  const E = TE(), t = X(), e = new Array(256);
  class _ {
    constructor(T) {
      this.columns = T || [];
    }
    static toPacket(T, a) {
      ...
      const R = Buffer.allocUnsafe(N + 4), i = new t(0, R, 0, N + 4);
    ...
    static fromPacket(T, a) {
      ...
      for (let R = 0; R < n.length; ++R)
        n[R] = e[T[R].columnType].apply(a);
      return new _(n);
    }
  }
  return e[E.DECIMAL] = t.prototype.readLengthCodedString, e[1] = t.prototype.readInt8, e[2] = t.prototype.readInt16, e[3] = t.prototype.readInt32, e[4] = t.prototype.readFloat, e[5] = t.prototype.readDouble, e[6] = t.prototype.assertInvalid, e[7] = t.prototype.readTimestamp, e[8] = t.prototype.readInt64, e[9] = t.prototype.readInt32, e[10] = t.prototype.readTimestamp, e[11] = t.prototype.readTime, e[12] = t.prototype.readDateTime, e[13] = t.prototype.readInt16, e[E.VAR_STRING] = t.prototype.readLengthCodedString, f_ = _, f_;
}
var g_, Ke;
function iE() {
  return Ke || (Ke = 1, g_ = {
...
function Ii() {
  ...
  class e {
    ...
    toPacket() {
      const A = 15 + Buffer.byteLength(this.filename, "utf8"), T = Buffer.allocUnsafe(A), a = new E(0, T, 0, A);
...
function ME() {
  return Je || (Je = 1, (function(E) {
    ...
    function e(a, n, N) {
      ...
      return R.update(a), n && R.update(n), N && R.update(N), R.digest();
    }
    function _(a, n) {
    ...
    function A(a, n, N) {
      ...
      const R = e(a);
      return E.calculateTokenFromPasswordSha(R, n, N);
    }
    E.calculateTokenFromPasswordSha = function(a, n, N) {
      const R = n.slice(0, 8), i = N.slice(0, 12), I = e(a), u = e(R, i, I);
      return _(u, a);
    }, E.calculateToken = A, E.verifyToken = function(a, n, N, R) {
      const i = _(N, e(a, n, R));
      return e(i).compare(R) === 0;
    }, E.doubleSha1 = function(a) {
      return e(e(a));
    };
    function T(a, n) {
      const N = Buffer.allocUnsafe(a.length), R = n.length;
...
function Ni() {
  ...
  class T {
    ...
    // };
    serializeToBuffer(n) {
      const N = (I) => this.flags & t[I], R = new e(0, n, 0, n.length);
      R.offset = 4;
      const i = A[this.charsetNumber];
      if (R.writeInt8(E.CHANGE_USER), R.writeNullTerminatedString(this.user, i), N("SECURE_CONNECTION") ? (R.writeInt8(this.authToken.length), R.writeBuffer(this.authToken)) : (R.writeBuffer(this.authToken), R.writeInt8(0)), R.writeNullTerminatedString(this.database, i), R.writeInt16(this.charsetNumber), N("PLUGIN_AUTH") && R.writeNullTerminatedString("mysql_native_password", "latin1"), N("CONNECT_ATTRS")) {
        const I = this.connectAttributes, u = Object.keys(I);
        let O = 0;
        for (let S = 0; S < u.length; ++S)
          O += e.lengthCodedStringLength(u[S], i), O += e.lengthCodedStringLength(
            I[u[S]],
            i
          );
        R.writeLengthCodedNumber(O);
        for (let S = 0; S < u.length; ++S)
          R.writeLengthCodedString(u[S], i), R.writeLengthCodedString(
            I[u[S]],
            i
          );
      }
...
function Ti() {
  ...
  class e {
    ...
    toPacket() {
      ...
      return A.offset = 4, A.writeInt8(t.STMT_CLOSE), A.writeInt32(this.id), A;
    }
  }
  return F_ = e, F_;
}
...
function ai() {
  if (xe) return Q_;
  xe = 1;
  const E = X(), t = qE(), e = IE(), _ = ["catalog", "schema", "table", "orgTable", "name", "orgName"];
  class A {
    constructor(n, N) {
      ...
      const R = n.readLengthCodedNumber(), i = n.offset;
      n.offset += R, this._orgNameLength = n.readLengthCodedNumber(), this._orgNameStart = n.offset, n.offset += this._orgNameLength, n.skip(1), this.characterSet = n.readInt16(), this.encoding = e[this.characterSet], this.name = t.decode(
        this._buf,
    ...
    [Symbol.for("nodejs.util.inspect.custom")](n, N, R) {
      const i = TE(), I = [];
      for (const r in i)
        I[i[r]] = r;
    ...
    static toPacket(n, N) {
      let R = 17;
      _.forEach((O) => {
        R += E.lengthCodedStringLength(
          n[O],
          e[n.characterSet]
        );
      });
      const i = Buffer.allocUnsafe(R), I = new E(N, i, 0, R);
      function u(O) {
      ...
      return I.offset = 4, _.forEach(u), I.writeInt8(12), I.writeInt16(n.characterSet), I.writeInt32(n.columnLength), I.writeInt8(n.columnType), I.writeInt16(n.flags), I.writeInt8(n.decimals), I.writeInt16(0), I;
    }
  ...
  const T = function(a) {
    Object.defineProperty(A.prototype, a, {
      get: function() {
        const n = this[`_${a}Start`], N = n + this[`_${a}Length`], R = t.decode(
          this._buf,
          this.encoding === "binary" ? this._clientEncoding : this.encoding,
          n,
          N
  ...
  return T("catalog"), T("schema"), T("table"), T("orgTable"), T("orgName"), Q_ = A, Q_;
}
var P_, $e;
function ri() {
  return $e || ($e = 1, P_ = {
...
function ui() {
  if (EA) return V_;
  EA = 1;
  const E = ri(), t = iE(), e = TE(), _ = X(), A = IE();
  function T(N) {
    return Array.isArray(N) || N.constructor === Object || typeof N.toJSON == "function" && !Buffer.isBuffer(N);
  }
  function a(N, R, i) {
    let I = e.VAR_STRING, u, O = function(S) {
      return _.prototype.writeLengthCodedString.call(this, S, R);
    };
    if (N !== null)
      switch (typeof N) {
        case "undefined":
        ...
        case "number":
          I = e.DOUBLE, u = 8, O = _.prototype.writeDouble;
          break;
        case "boolean":
          N = N | 0, I = e.TINY, u = 1, O = _.prototype.writeInt8;
          break;
        case "object":
          Object.prototype.toString.call(N) === "[object Date]" ? (I = e.DATETIME, u = 12, O = function(S) {
            return _.prototype.writeDate.call(this, S, i);
          }) : T(N) ? (N = JSON.stringify(N), I = e.JSON) : Buffer.isBuffer(N) && (u = _.lengthCodedNumberLength(N.length) + N.length, O = _.prototype.writeLengthCodedBuffer);
          break;
        default:
          N = N.toString();
      }
      ...
      N = "", I = e.NULL;
    return u || (u = _.lengthCodedStringLength(N, R)), { value: N, type: I, length: u, writer: O };
  }
  class n {
    constructor(R, i, I, u) {
      this.id = R, this.parameters = i, this.encoding = A[I], this.timezone = u;
    }
    static fromPacket(R, i) {
      const I = R.readInt32(), u = R.readInt8(), O = R.readInt32();
      let S = R.offset;
      for (; S < R.end - 1 && !((R.buffer[S + 1] === e.VAR_STRING || R.buffer[S + 1] === e.NULL || R.buffer[S + 1] === e.DOUBLE || R.buffer[S + 1] === e.TINY || R.buffer[S + 1] === e.DATETIME || R.buffer[S + 1] === e.JSON) && R.buffer[S] === 1 && R.buffer[S + 2] === 0); )
        R.readInt8(), S++;
      const c = [];
      for (let r = R.offset + 1; r < R.end - 1; r++)
        (R.buffer[r] === e.VAR_STRING || R.buffer[r] === e.NULL || R.buffer[r] === e.DOUBLE || R.buffer[r] === e.TINY || R.buffer[r] === e.DATETIME || R.buffer[r] === e.JSON) && R.buffer[r + 1] === 0 && (c.push(R.buffer[r]), R.skip(2));
      R.skip(1);
      const s = [];
      for (let r = 0; r < c.length; r++)
        c[r] === e.VAR_STRING ? s.push(R.readLengthCodedString(i)) : c[r] === e.DOUBLE ? s.push(R.readDouble()) : c[r] === e.TINY ? s.push(R.readInt8()) : c[r] === e.DATETIME ? s.push(R.readDateTime()) : c[r] === e.JSON && s.push(JSON.parse(R.readLengthCodedString(i))), c[r] === e.NULL && s.push(null);
      return { stmtId: I, flags: u, iterationCount: O, values: s };
    }
    toPacket() {
      let R = 14, i;
      this.parameters && this.parameters.length > 0 && (R += Math.floor((this.parameters.length + 7) / 8), R += 1, R += 2 * this.parameters.length, i = this.parameters.map(
        (O) => a(O, this.encoding, this.timezone)
      ), R += i.reduce(
        (O, S) => O + S.length,
        0
      ));
      const I = Buffer.allocUnsafe(R), u = new _(0, I, 0, R);
      if (u.offset = 4, u.writeInt8(t.STMT_EXECUTE), u.writeInt32(this.id), u.writeInt8(E.NO_CURSOR), u.writeInt32(1), i) {
        let O = 0, S = 1;
        i.forEach((c) => {
          c.type === e.NULL && (O += S), S *= 2, S === 256 && (u.writeInt8(O), O = 0, S = 1);
        }), S !== 1 && u.writeInt8(O), u.writeInt8(1), i.forEach((c) => {
          u.writeInt8(c.type), u.writeInt8(0);
        }), i.forEach((c) => {
          c.type !== e.NULL && c.writer.call(u, c.value);
        });
      }
      return u;
    }
  ...
  class e {
    ...
    setScrambleData(A) {
      wE.randomBytes(20, (T, a) => {
        ...
        this.authPluginData1 = a.slice(0, 8), this.authPluginData2 = a.slice(8, 20), A();
      });
    }
    toPacket(A) {
      const T = 68 + Buffer.byteLength(this.serverVersion, "utf8"), a = Buffer.alloc(T + 4, 0), n = new E(A, a, 0, T + 4);
    ...
    static fromPacket(A) {
      ...
      if (a[0] = A.readInt8(), a[1] = A.readInt8(), A.haveMoreData() ? (T.characterSet = A.readInt8(), T.statusFlags = A.readInt16(), a[2] = A.readInt8(), a[3] = A.readInt8(), T.capabilityFlags = a.readUInt32LE(0), T.capabilityFlags & t.PLUGIN_AUTH ? T.authPluginDataLength = A.readInt8() : (T.authPluginDataLength = 0, A.skip(1)), A.skip(10)) : T.capabilityFlags = a.readUInt16LE(0), T.capabilityFlags & t.SECURE_CONNECTION) {
        const N = T.authPluginDataLength;
        if (N === 0)
          T.authPluginDataLength = 20, T.authPluginData2 = A.readBuffer(12), A.skip(1);
        else {
          const R = Math.max(13, N - 8);
          T.authPluginData2 = A.readBuffer(R);
        }
      }
      return T.capabilityFlags & t.PLUGIN_AUTH && (T.authPluginName = A.readNullTerminatedString("ascii")), new e(T);
    }
  }
  return b_ = e, b_;
}
  ...
  class A {
    constructor(a) {
      ...
      this.passwordSha1 ? n = _.calculateTokenFromPasswordSha(
        ...
        this.authPluginData1,
        this.authPluginData2
      ), this.authToken = n, this.charsetNumber = a.charsetNumber, this.encoding = t[a.charsetNumber], this.connectAttributes = a.connectAttributes;
    }
    serializeResponse(a) {
      const n = (I) => this.clientFlags & E[I], N = new e(0, a, 0, a.length);
      N.offset = 4, N.writeInt32(this.clientFlags), N.writeInt32(0), N.writeInt8(this.charsetNumber), N.skip(23);
      const R = this.encoding;
      N.writeNullTerminatedString(this.user, R);
      let i;
      if (n("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (N.writeLengthCodedNumber(this.authToken.length), N.writeBuffer(this.authToken)) : n("SECURE_CONNECTION") ? (N.writeInt8(this.authToken.length), N.writeBuffer(this.authToken)) : (N.writeBuffer(this.authToken), N.writeInt8(0)), n("CONNECT_WITH_DB") && N.writeNullTerminatedString(this.database, R), n("PLUGIN_AUTH") && N.writeNullTerminatedString("mysql_native_password", "latin1"), n("CONNECT_ATTRS")) {
        const I = this.connectAttributes || {}, u = Object.keys(I);
        let O = 0;
        for (i = 0; i < u.length; ++i)
          O += e.lengthCodedStringLength(u[i], R), O += e.lengthCodedStringLength(
            I[u[i]],
            R
          );
        for (N.writeLengthCodedNumber(O), i = 0; i < u.length; ++i)
          N.writeLengthCodedString(u[i], R), N.writeLengthCodedString(
            I[u[i]],
            R
          );
      }
    ...
    toPacket() {
      ...
      if (typeof this.database != "string")
        throw new Error('"database" connection config property must be a string');
      const a = this.serializeResponse(e.MockBuffer());
      return this.serializeResponse(Buffer.alloc(a.offset));
    }
    static fromPacket(a) {
      const n = {};
      n.clientFlags = a.readInt32();
      function N(I) {
        return n.clientFlags & E[I];
      }
      n.maxPacketSize = a.readInt32(), n.charsetNumber = a.readInt8();
      const R = t[n.charsetNumber];
      n.encoding = R, a.skip(23), n.user = a.readNullTerminatedString(R);
      let i;
      if (N("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (i = a.readLengthCodedNumber(R), n.authToken = a.readBuffer(i)) : N("SECURE_CONNECTION") ? (i = a.readInt8(), n.authToken = a.readBuffer(i)) : n.authToken = a.readNullTerminatedString(R), N("CONNECT_WITH_DB") && (n.database = a.readNullTerminatedString(R)), N("PLUGIN_AUTH") && (n.authPluginName = a.readNullTerminatedString(R)), N("CONNECT_ATTRS")) {
        const I = a.readLengthCodedNumber(R), u = a.offset + I, O = {};
        for (; a.offset < u; )
          O[a.readLengthCodedString(R)] = a.readLengthCodedString(R);
        n.connectAttributes = O;
      }
      return n;
    }
  }
...
function si() {
  if (eA) return Y_;
  eA = 1;
  const E = X(), t = iE(), e = qE(), _ = IE();
  class A {
    constructor(a, n) {
      this.query = a, this.charsetNumber = n, this.encoding = _[n];
    }
    toPacket() {
      const a = e.encode(this.query, this.encoding), n = 5 + a.length, N = Buffer.allocUnsafe(n), R = new E(0, N, 0, n);
      return R.offset = 4, R.writeInt8(t.STMT_PREPARE), R.writeBuffer(a), R;
    }
  }
  return Y_ = A, Y_;
}
...
function Di() {
  ...
  class A {
    ...
    toPacket() {
      const a = e.encode(this.query, this.encoding), n = 5 + a.length, N = Buffer.allocUnsafe(n), R = new E(0, N, 0, n);
      return R.offset = 4, R.writeInt8(t.QUERY), R.writeBuffer(a), R;
    }
  }
  return H_ = A, H_;
}
...
function Si() {
  ...
  class e {
    ...
    toPacket() {
      ...
      Buffer.byteLength(this.slaveHostname, "utf8") + Buffer.byteLength(this.slaveUser, "utf8") + Buffer.byteLength(this.slavePassword, "utf8") + 3 + 4, T = Buffer.allocUnsafe(A), a = new E(0, T, 0, A);
...
function Mi() {
  if (TA) return K_;
  TA = 1;
  const E = X(), t = uE(), e = WR(), _ = Bi(), A = li();
  class T {
    constructor(n, N) {
      const R = N.config.bigNumberStrings, i = N.serverEncoding, I = N._handshakePacket.capabilityFlags, u = function(c) {
        return I & t[c];
      };
      ...
      this.fieldCount = n.readInt8(), this.affectedRows = n.readLengthCodedNumber(R), this.insertId = n.readLengthCodedNumberSigned(R), this.info = "", u("PROTOCOL_41") ? (this.serverStatus = n.readInt16(), this.warningStatus = n.readInt16()) : u("TRANSACTIONS") && (this.serverStatus = n.readInt16());
      let O = null;
      if (u("SESSION_TRACK") && n.offset < n.end) {
        if (this.info = n.readLengthCodedString(i), this.serverStatus && e.SERVER_SESSION_STATE_CHANGED) {
          let c = n.offset < n.end ? n.readLengthCodedNumber() : 0;
          const s = n.offset + c;
          let r, C, D;
          for (c > 0 && (O = {
            systemVariables: {},
            ...
            if (r = n.readInt8(), c = n.readLengthCodedNumber(), D = n.offset + c, r === A.SYSTEM_VARIABLES) {
              C = n.readLengthCodedString(i);
              ...
              C = n.readLengthCodedString(i), O.schema = C;
            else if (r === A.STATE_CHANGE)
              O.trackStateChange = n.readLengthCodedString(i);
    ...
    static toPacket(n, N) {
      let R = 4 + E.lengthCodedNumberLength(n);
      typeof N < "u" && (R += E.lengthCodedNumberLength(N));
      const i = Buffer.allocUnsafe(R), I = new E(0, i, 0, R);
      return I.offset = 4, I.writeLengthCodedNumber(n), typeof N < "u" && I.writeLengthCodedNumber(N), I;
    }
  }
  return K_ = T, K_;
}
  ...
  class t {
    ...
    static toPacket(_, A) {
      ...
      _.forEach((R) => {
        ...
        a += E.lengthCodedStringLength(R.toString(10), A);
      });
      const n = Buffer.allocUnsafe(a + 4), N = new E(0, n, 0, a + 4);
      return N.offset = 4, _.forEach((R) => {
        if (R === null) {
          N.writeNull();
          return;
        }
        ...
        N.writeLengthCodedString(R.toString(10), A);
      }), N;
    }
  }
  return k_ = t, k_;
...
function eE() {
  return uA || (uA = 1, (function(E, t) {
    const e = zE, _ = ei(), A = Ai(), T = Ri(), a = ti(), n = ii(), N = Ii(), R = Ni(), i = Ti(), I = ai(), u = ui(), O = ci(), S = Oi(), c = si(), s = Ci(), r = Di(), C = Si(), D = Mi(), B = hi(), M = Li();
    Object.entries({
      AuthNextFactor: _,
      AuthSwitchRequest: A,
  ...
  class e extends E {
    ...
    execute(A, T) {
      if (this.next || (this.next = this.start, T._resetSequenceId()), A && A.isError()) {
        const a = A.asError(T.clientEncoding);
...
function oi() {
  if (OA) return z_;
  OA = 1;
  const E = "sha256_password", t = wE, { xorRotating: e } = ME(), _ = wR, A = Buffer.from([1]), T = 0, a = 1, n = -1;
  function N(R, i, I) {
    const u = e(Buffer.from(`${R}\0`, "utf8"), i);
    return t.publicEncrypt(I, u);
  }
  return z_ = (R = {}) => ({ connection: i }) => {
    let I = 0, u = null;
    ...
    return (c) => {
      switch (I) {
        case T:
          return i.stream instanceof _.TLSSocket && i.stream.encrypted === !0 ? Buffer.from(`${O}\0`, "utf8") : (u = c.slice(0, 20), R.serverPublicKey ? S(R.serverPublicKey) : (I = a, A));
        case a:
          return R.onServerPublicKey && R.onServerPublicKey(c), S(c);
        case n:
          throw new Error(
...
function fi() {
  if (sA) return Z_;
  sA = 1;
  const E = "caching_sha2_password", t = wE, { xor: e, xorRotating: _ } = ME(), A = Buffer.from([2]), T = Buffer.from([3]), a = Buffer.from([4]), n = 0, N = 1, R = 2, i = -1;
  function I(S) {
      ...
      switch (s) {
        ...
        case N:
          if (T.equals(B))
            return s = i, null;
          if (a.equals(B))
            return (typeof S.overrideIsSecure > "u" ? c.config.ssl || c.config.socketPath : S.overrideIsSecure) ? (s = i, Buffer.from(`${C}\0`, "utf8")) : S.serverPublicKey ? D(S.serverPublicKey) : (s = R, A);
          throw new Error(
...
function gi() {
  ...
  CA = 1;
  const E = ME();
  return q_ = (t) => ({ connection: e, command: _ }) => {
    const A = _.password || t.password || e.config.password, T = _.passwordSha1 || t.passwordSha1 || e.config.passwordSha1;
    return (a) => {
      const n = a.slice(0, 8), N = a.slice(8, 20);
      let R;
      return T ? R = E.calculateTokenFromPasswordSha(
        T,
        n,
        N
      ) : R = E.calculateToken(
...
function Ui() {
  ...
  return p_ = (e) => function({ connection: A, command: T }) {
    const a = T.password || e.password || A.config.password;
    return function() {
      return E(a);
    };
  }, p_;
...
function di() {
  if (SA) return x_;
  SA = 1;
  const E = eE(), t = oi(), e = fi(), _ = gi(), A = Ui(), T = {
    sha256_password: t({}),
  ...
  return x_ = {
    authSwitchRequest: N,
    authSwitchRequestMoreData: R
  }, x_;
}
var $_ = { exports: {} }, BA;
function wi() {
  return BA || (BA = 1, (function(E) {
    var t = aE.EventEmitter, e = QR, _ = 3e3, A = 0, T = "closed", a = "drained", n = function(R) {
      t.call(this), R && R > 0 ? this.timeout = R : this.timeout = _, this.status = N.STATUS_IDLE, this.curId = A, this.queue = [];
    };
    e.inherits(n, t), n.prototype.push = function(R, i, I) {
      if (this.status !== N.STATUS_IDLE && this.status !== N.STATUS_BUSY)
        return !1;
      if (typeof R != "function")
        throw new Error("fn should be a function.");
      if (this.queue.push({ fn: R, ontimeout: i, timeout: I }), this.status === N.STATUS_IDLE) {
      ...
      return !0;
    }, n.prototype.close = function(R) {
      this.status !== N.STATUS_IDLE && this.status !== N.STATUS_BUSY || (R ? (this.status = N.STATUS_DRAINED, this.timerId && (clearTimeout(this.timerId), this.timerId = void 0), this.emit(a)) : (this.status = N.STATUS_CLOSED, this.emit(T)));
    }, n.prototype._next = function(R) {
      if (!(R !== this.curId || this.status !== N.STATUS_BUSY && this.status !== N.STATUS_CLOSED)) {
    ...
    var N = E.exports;
    N.STATUS_IDLE = 0, N.STATUS_BUSY = 1, N.STATUS_CLOSED = 2, N.STATUS_DRAINED = 3, N.createQueue = function(R) {
      return new n(R);
    };
  })($_)), $_.exports;
}
...
function Fi() {
  ...
  const E = Lt, t = YR();
  function e(T) {
    const a = this, n = T.readInt24(), N = T.readBuffer();
    n !== 0 ? a.inflateQueue.push((R) => {
      E.inflate(N, (i, I) => {
        if (i) {
          a._handleNetworkError(i);
          return;
        }
        a._bumpCompressedSequenceId(T.numPackets), a._inflatedPacketsParser.execute(I), R.done();
      });
    }) : a.inflateQueue.push((R) => {
      a._bumpCompressedSequenceId(T.numPackets), a._inflatedPacketsParser.execute(N), R.done();
    });
  }
  function _(T) {
    let n;
    if (T.length > 16777210) {
      for (n = 0; n < T.length; n += 16777210)
        _.call(
          // eslint-disable-next-line no-invalid-this
          this,
          T.slice(n, n + 16777210)
        );
      return;
    }
    const N = this;
    ...
    (function(I) {
      N.deflateQueue.push((u) => {
        E.deflate(T, (O, S) => {
          ...
          let c = S.length;
          c < R ? (i.writeUInt8(c & 255, 0), i.writeUInt16LE(c >> 8, 1), i.writeUInt8(I, 3), i.writeUInt8(R & 255, 4), i.writeUInt16LE(R >> 8, 5), N.writeUncompressed(i), N.writeUncompressed(S)) : (c = R, R = 0, i.writeUInt8(c & 255, 0), i.writeUInt16LE(c >> 8, 1), i.writeUInt8(I, 3), i.writeUInt8(R & 255, 4), i.writeUInt16LE(R >> 8, 5), N.writeUncompressed(i), N.writeUncompressed(T)), u.done();
        });
      });
    })(N.compressedSequenceId), N._bumpCompressedSequenceId(1);
  }
  function A(T) {
    T._lastWrittenPacketId = 0, T._lastReceivedPacketId = 0, T._handleCompressedPacket = e, T._inflatedPacketsParser = new t((n) => {
      T.handlePacket(n);
    }, 4), T._inflatedPacketsParser._lastPacket = 0, T.packetParser = new t((n) => {
      T._handleCompressedPacket(n);
...
function HR() {
  if (hA) return nn;
  hA = 1;
  const E = AE(), t = eE(), e = uE(), _ = IE(), A = ME();
  function T(n) {
    const N = [];
    for (const R in e)
      n & e[R] && N.push(R.replace(/_/g, " ").toLowerCase());
    return N;
  }
  class a extends E {
    constructor(N) {
    ...
    sendSSLRequest(N) {
      const R = new t.SSLRequest(
        this.clientFlags,
        N.config.charsetNumber
      );
      N.writePacket(R.toPacket());
    }
    sendCredentials(N) {
      ...
      const R = new t.HandshakeResponse({
    ...
    handshakeInit(N, R) {
      this.on("error", (u) => {
        R._fatalError = u, R._protocolError = u;
      }), this.handshake = t.Handshake.fromPacket(N), R.config.debug && console.log(
        "Server hello packet: capability flags:%d=(%s)",
        this.handshake.capabilityFlags,
        T(this.handshake.capabilityFlags).join(", ")
      ), R.serverCapabilityFlags = this.handshake.capabilityFlags, R.serverEncoding = _[this.handshake.characterSet], R.connectionId = this.handshake.connectionId;
      const i = this.handshake.capabilityFlags & e.SSL, I = this.handshake.capabilityFlags & e.MULTI_FACTOR_AUTHENTICATION;
      if (this.clientFlags = this.clientFlags | I, R.config.compress = R.config.compress && this.handshake.capabilityFlags & e.COMPRESS, this.clientFlags = this.clientFlags | R.config.compress, R.config.ssl) {
        if (!i) {
        ...
        this.clientFlags |= e.SSL, this.sendSSLRequest(R), R.startTLS((u) => {
          if (u) {
            u.code = "HANDSHAKE_SSL_ERROR", u.fatal = !0, this.emit("error", u);
            return;
          }
          this.sendCredentials(R);
        });
      } else
        this.sendCredentials(R);
    ...
    handshakeResult(N, R) {
      ...
      if (i === 254 || i === 1 || i === 2) {
        const I = di();
        try {
          return i === 1 ? I.authSwitchRequestMoreData(N, R, this) : (this.authenticationFactor !== 0 && (R.config.password = this[`password${this.authenticationFactor}`], this.authenticationFactor += 1), I.authSwitchRequest(N, R, this)), a.prototype.handshakeResult;
        } catch (u) {
      ...
      if (!R.authorized && (R.authorized = !0, R.config.compress)) {
        const I = Fi().enableCompression;
        I(R);
      }
...
function Qi() {
  ...
  class A extends e {
    ...
    start(a, n) {
      ...
      return this.serverHello = N, N.setScrambleData((R) => {
        if (R) {
    ...
    readClientReply(a, n) {
      ...
      ) : n.writeOk(), A.prototype.dispatchCommands;
    }
    _isStatement(a, n) {
      return a.split(" ")[0].toUpperCase() === n;
    }
    dispatchCommands(a, n) {
      let N = !0;
      const R = n.clientHelloReply.encoding, i = a.readInt8();
      switch (i) {
        case E.STMT_PREPARE:
          if (n.listeners("stmt_prepare").length) {
            const I = a.readString(void 0, R);
            n.emit("stmt_prepare", I);
          } else
            n.writeError({
        ...
        case E.STMT_EXECUTE:
          if (n.listeners("stmt_execute").length) {
            const { stmtId: I, flags: u, iterationCount: O, values: S } = _.Execute.fromPacket(a, R);
            n.emit(
              "stmt_execute",
              I,
              u,
        ...
        case E.QUERY:
          if (n.listeners("query").length) {
            const I = a.readString(void 0, R);
            this._isStatement(I, "PREPARE") || this._isStatement(I, "SET") ? n.emit("stmt_prepare", I) : this._isStatement(I, "EXECUTE") ? n.emit("stmt_execute", null, null, null, null, I) : n.emit("query", I);
          } else
            n.writeError({
              code: t.HA_ERR_INTERNAL_ERROR,
        ...
        case E.FIELD_LIST:
          if (n.listeners("field_list").length) {
            const I = a.readNullTerminatedString(R), u = a.readString(void 0, R);
            n.emit("field_list", I, u);
          } else
            n.writeError({
      ...
      return n.listeners("packet").length ? n.emit("packet", a.clone(), N, i) : N || console.log("Unknown command:", i), A.prototype.dispatchCommands;
    }
  }
  return en = A, en;
}
...
function pE() {
  ...
  try {
    ...
    t = (n) => (e || (console.log("For nicer debug output consider install cardinal@^2.0.0"), e = !0), n);
  }
  function _(n, N) {
    console.log(`
...
`);
  ...
  function A(n, N, R) {
    return Array.isArray(N) ? N.some((i) => n === R[i]) : !!N;
  }
  OE.typeMatch = A;
...
function vR() {
  ...
  var n = function(i) {
    ...
    var i = [], I = 0, u = {}, O = function(s) {
      ...
      if (_.test(s.trim()[0]) && e.test(s[s.length - 1])) {
        I--, O(s), I++;
        return;
      }
      if (e.test(s[s.length - 1])) {
        O(s), I++;
        return;
      }
      if (_.test(s.trim()[0])) {
...
`), C = 0; C < r.length; C++)
    ...
    return c.scope = {}, c.formats = N, c.sym = function(s) {
      return (!s || !n(s)) && (s = "tmp"), u[s] || (u[s] = 0), s + (u[s]++ || "");
...
`);
  ...
  return R.formats = N, tn = R, tn;
}
var In, dA;
function bi() {
  if (dA) return In;
  dA = 1;
  const E = TE(), t = hE(), e = pE(), _ = vR(), A = pn(), T = [];
  for (const R in E)
    T[E[R]] = R;
  function a(R, i, I, u, O) {
    ...
    switch (R) {
      ...
      case E.DATE:
        return e.typeMatch(R, r, E) ? 'packet.readLengthCodedString("ascii")' : `packet.parseDate(${e.srcEscape(s)})`;
      case E.DATETIME:
      case E.TIMESTAMP:
        return e.typeMatch(R, r, E) ? 'packet.readLengthCodedString("ascii")' : `packet.parseDateTime(${e.srcEscape(s)})`;
      case E.TIME:
  ...
  function n(R, i, I) {
    ...
    const O = _();
    O("(function () {")("return class TextRow {"), O("constructor(fields) {"), typeof i.typeCast == "function" && (O("const _this = this;"), O("for(let i=0; i<fields.length; ++i) {"), O("this[`wrap${i}`] = wrap(fields[i], _this);"), O("}")), O("}"), O("next(packet, fields, options) {"), O("this.packet = packet;"), i.rowsAsArray ? O(`const result = new Array(${R.length});`) : O("const result = {};");
    const S = {};
    let c = [];
    if (i.nestTables === !0) {
      ...
      for (let D = 0; D < c.length; D++)
        O(`result[${e.fieldEscape(c[D])}] = {};`);
    }
    let s = "", r = "", C = "";
    for (let D = 0; D < R.length; D++)
      if (r = e.fieldEscape(R[D].name), typeof i.nestTables == "string" ? s = `result[${e.fieldEscape(R[D].table + i.nestTables + R[D].name)}]` : i.nestTables === !0 ? (C = e.fieldEscape(R[D].table), O(`if (!result[${C}]) result[${C}] = {};`), s = `result[${C}][${r}]`) : i.rowsAsArray ? s = `result[${D.toString(10)}]` : s = `result[${r}]`, i.typeCast === !1)
    ...
    return O("return result;"), O("}"), O("};")("})()"), I.debug && e.printDebugWithCode(
      "Compiled text protocol row parser",
      O.toString()
    ), typeof i.typeCast == "function" ? O.toFunction({ wrap: u }) : O.toFunction();
  }
  function N(R, i, I) {
    return A.getParser("text", R, i, I, n);
  }
  return In = N, In;
}
var Nn, wA;
function mi() {
  if (wA) return Nn;
  wA = 1;
  const E = TE(), t = hE(), e = pE(), _ = [];
  for (const n in E)
    _[E[n]] = n;
  function A({ packet: n, type: N, charset: R, encoding: i, config: I, options: u }) {
    ...
    switch (N) {
      ...
      case E.LONGLONG:
        return O && S ? n.parseLengthCodedIntString() : n.parseLengthCodedInt(O);
      case E.FLOAT:
      case E.DOUBLE:
      ...
      case E.DECIMAL:
      case E.NEWDECIMAL:
        return I.decimalNumbers ? n.parseLengthCodedFloat() : n.readLengthCodedString("ascii");
      case E.DATE:
        return e.typeMatch(N, s, E) ? n.readLengthCodedString("ascii") : n.parseDate(c);
      case E.DATETIME:
      case E.TIMESTAMP:
        return e.typeMatch(N, s, E) ? n.readLengthCodedString("ascii") : n.parseDateTime(c);
      case E.TIME:
      ...
      case E.JSON:
        return I.jsonStrings ? n.readLengthCodedString("utf8") : JSON.parse(n.readLengthCodedString("utf8"));
      default:
        return R === t.BINARY ? n.readLengthCodedBuffer() : n.readLengthCodedString(i);
    }
  }
  function T(n, N) {
    return {
      ...
      table: n.table,
      name: n.name,
      string: function(R = n.encoding) {
        return n.columnType === E.JSON && R === n.encoding && console.warn(
    ...
    return {
      next(i, I, u) {
        ...
        for (let S = 0; S < I.length; S++) {
          const c = I[S], s = u.typeCast ? u.typeCast : R.typeCast, r = () => A({
            packet: i,
            type: c.columnType,
            encoding: c.encoding,
          ...
          if (u.typeCast === !1 ? C = i.readLengthCodedBuffer() : typeof s == "function" ? C = s(T(c, i), r) : C = r(), u.rowsAsArray)
            ...
            O[`${e.fieldEscape(c.table, !1)}${u.nestTables}${e.fieldEscape(c.name, !1)}`] = C;
          else if (u.nestTables) {
            const D = e.fieldEscape(c.table, !1);
            O[D] || (O[D] = {}), O[D][e.fieldEscape(c.name, !1)] = C;
          } else
            O[e.fieldEscape(c.name, !1)] = C;
        }
        return O;
      }
    };
...
function yR() {
  if (GA) return Tn;
  GA = 1;
  const E = zE, t = Zn, e = GR.Readable, _ = AE(), A = eE(), T = bi(), a = mi(), n = WR(), N = new A.Packet(0, Buffer.allocUnsafe(4), 0, 4);
  class R extends _ {
    constructor(I, u) {
    ...
    start(I, u) {
      ...
      return u.writePacket(O.toPacket(1)), R.prototype.resultsetHeader;
    }
    done() {
    ...
    doneInsert(I) {
      return this._localStreamError ? (this.onResult ? this.onResult(this._localStreamError, I) : this.emit("error", this._localStreamError), null) : (this._rows.push(I), this._fields.push(void 0), this.emit("fields", void 0), this.emit("result", I), I.serverStatus & n.SERVER_MORE_RESULTS_EXISTS ? (this._resultIndex++, this.resultsetHeader) : this.done());
    }
    resultsetHeader(I, u) {
      const O = new A.ResultSetHeader(I, u);
    ...
    readField(I, u) {
      if (this._receivedFieldsCount++, this._fields[this._resultIndex].length !== this._fieldCount) {
        const O = new A.ColumnDefinition(
          I,
          u.clientEncoding
        );
      ...
      if (this._receivedFieldsCount === this._fieldCount) {
        ...
        return this.emit("fields", O), this.options.disableEval ? this._rowParser = a(O, this.options, u.config) : this._rowParser = new (T(
          ...
          this.options,
          u.config
        ))(O), R.prototype.fieldsEOF;
      }
      return R.prototype.readField;
    }
    fieldsEOF(I, u) {
    ...
    row(I, u) {
      if (I.isEOF())
        return I.eofStatusFlags() & n.SERVER_MORE_RESULTS_EXISTS ? (this._resultIndex++, R.prototype.resultsetHeader) : this.done();
      let O;
      try {
      ...
      return this.onResult ? this._rows[this._resultIndex].push(O) : this.emit("result", O, this._resultIndex), R.prototype.row;
    }
    infileOk(I, u) {
      const O = new A.ResultSetHeader(I, u);
  ...
  return R.prototype.catch = R.prototype.then, Tn = R, Tn;
}
var an, FA;
function XR() {
  if (FA) return an;
...
function Yi() {
  if (QA) return rn;
  QA = 1;
  const E = xn(), t = hE(), e = TE(), _ = pE(), A = vR(), T = pn(), a = [];
  for (const i in e)
    a[e[i]] = i;
  function n(i, I, u, O) {
    ...
    switch (i.columnType) {
      ...
      case e.TIMESTAMP:
      case e.NEWDATE:
        return _.typeMatch(i.columnType, r, e) ? `packet.readDateTimeString(${parseInt(i.decimals, 10)}, null, ${i.columnType});` : `packet.readDateTime(${_.srcEscape(s)});`;
      case e.TIME:
  ...
  function N(i, I, u) {
    const O = A(), S = Math.floor((i.length + 7 + 2) / 8);
    function c(M, h) {
      return {
        type: a[M.columnType],
        ...
        string: function(L = M.encoding) {
          if (M.columnType === e.JSON && L === M.encoding && console.warn(
          ...
          if (M.columnType === e.TINY) {
            const U = M.flags & E.UNSIGNED;
            return String(U ? h.readInt8() : h.readSInt8());
          }
          return M.columnType === e.TIME ? h.readTimeString() : h.readLengthCodedString(L);
        },
        buffer: function() {
...
function Wi() {
  if (PA) return un;
  PA = 1;
  const E = xn(), t = hE(), e = TE(), _ = pE(), A = [];
  for (const a in e)
    A[e[a]] = a;
  function T(a, n, N) {
    function R(i, I, u, O, S) {
      ...
      switch (i.columnType) {
        ...
        case e.TIMESTAMP:
        case e.NEWDATE:
          return _.typeMatch(i.columnType, C, e) ? S.readDateTimeString(
            ...
            h = typeof M == "function" ? M(
              {
                ...
                string: function(U = B.encoding) {
                  ...
                  return B.columnType === e.TIME ? I.readTimeString() : I.readLengthCodedString(U);
                },
                buffer: function() {
...
function KR() {
  if (VA) return cn;
  VA = 1;
  const E = AE(), t = yR(), e = eE(), _ = Yi(), A = Wi();
  class T extends E {
    constructor(n, N) {
    ...
    buildParserFromFields(n, N) {
      return this.options.disableEval ? A(n, this.options, N.config) : _(n, this.options, N.config);
    }
    start(n, N) {
      this._connection = N, this.options = Object.assign({}, N.config, this._executeOptions), this._setTimeout();
      const R = new e.Execute(
        this.statement.id,
        this.parameters,
        N.config.charsetNumber,
        N.config.timezone
    ...
    readField(n, N) {
      ...
      return this._receivedFieldsCount++, this._fields[this._resultIndex].push(i), this._receivedFieldsCount === this._fieldCount ? (R = this._fields[this._resultIndex], this.emit("fields", R, this._resultIndex), T.prototype.fieldsEOF) : T.prototype.readField;
    }
    fieldsEOF(n, N) {
...
function Hi() {
  if (bA) return On;
  bA = 1;
  const E = eE(), t = AE(), e = XR(), _ = KR();
  class A {
    constructor(n, N, R, i, I) {
      this.query = n, this.id = N, this.columns = R, this.parameters = i, this.rowParser = null, this._connection = I;
    }
    close() {
  ...
  class T extends t {
    ...
    start(n, N) {
      ...
      this.key = R.statementKey(this.options);
    ...
    prepareHeader(n, N) {
      const R = new E.PreparedStatementHeader(n);
      return this.id = R.id, this.fieldCount = R.fieldCount, this.parameterCount = R.parameterCount, this.parameterCount > 0 ? T.prototype.readParameter : this.fieldCount > 0 ? T.prototype.readField : this.prepareDone(N);
    }
    readParameter(n, N) {
      if (n.isEOF())
        return this.fieldCount > 0 ? T.prototype.readField : this.prepareDone(N);
      const R = new E.ColumnDefinition(n, N.clientEncoding);
      return this.parameterDefinitions.push(R), this.parameterDefinitions.length === this.parameterCount ? T.prototype.parametersEOF : this.readParameter;
    }
    readField(n, N) {
      if (n.isEOF())
        return this.prepareDone(N);
      const R = new E.ColumnDefinition(n, N.clientEncoding);
      return this.fields.push(R), this.fields.length === this.fieldCount ? T.prototype.fieldsEOF : T.prototype.readField;
    }
    parametersEOF(n, N) {
      return n.isEOF() ? this.fieldCount > 0 ? T.prototype.readField : this.prepareDone(N) : N.protocolError("Expected EOF packet after parameters");
    }
    fieldsEOF(n, N) {
...
function vi() {
  ...
  class _ extends E {
    ...
    start(T, a) {
      ...
      return a.writePacket(n), _.prototype.pingResponse;
    }
    pingResponse() {
...
function yi() {
  ...
  class e extends E {
    ...
    start(A, T) {
      ...
      return T.writePacket(a.toPacket(1)), e.prototype.registerResponse;
    }
    registerResponse() {
      return this.onResult && process.nextTick(this.onResult.bind(this)), null;
    }
...
function Xi() {
  ...
  return Dn = function(e) {
    ...
    for (; A < e.length; )
      switch (T = e[A++], T) {
        case E.FLAGS2:
          _.flags = e.readUInt32LE(A), A += 4;
          break;
        case E.SQL_MODE:
          _.sqlMode = e.readUInt32LE(A), A += 8;
          break;
        case E.CATALOG:
          a = e[A++], _.catalog = e.toString("utf8", A, A + a), A += a + 1;
          break;
        case E.CHARSET:
          _.clientCharset = e.readUInt16LE(A), _.connectionCollation = e.readUInt16LE(A + 2), _.serverCharset = e.readUInt16LE(A + 4), A += 6;
          break;
        case E.TIME_ZONE:
          a = e[A++], _.timeZone = e.toString("utf8", A, A + a), A += a;
          break;
        case E.CATALOG_NZ:
          a = e[A++], _.catalogNz = e.toString("utf8", A, A + a), A += a;
          break;
        case E.LC_TIME_NAMES:
          _.lcTimeNames = e.readUInt16LE(A), A += 2;
          break;
        case E.CHARSET_DATABASE:
          _.schemaCharset = e.readUInt16LE(A), A += 2;
          break;
        case E.TABLE_MAP_FOR_UPDATE:
          _.mapForUpdate1 = e.readUInt32LE(A), _.mapForUpdate2 = e.readUInt32LE(A + 4), A += 8;
          break;
        case E.MASTER_DATA_WRITTEN:
          _.masterDataWritten = e.readUInt32LE(A), A += 4;
          break;
        case E.INVOKERS:
          a = e[A++], _.invokerUsername = e.toString(
            "utf8",
            A,
            A + a
          ), A += a, a = e[A++], _.invokerHostname = e.toString(
            "utf8",
            A,
            A + a
          ), A += a;
        ...
        case E.UPDATED_DB_NAMES:
          for (a = e[A++], _.updatedDBs = []; a; --a) {
            for (n = A; e[A++] && A < e.length; )
              ;
            _.updatedDBs.push(
              e.toString("utf8", n, A - 1)
            );
          }
          break;
        case E.MICROSECONDS:
          _.microseconds = // REVIEW: INVALID UNKNOWN VARIABLE!
          e.readInt16LE(A) + (e[A + 2] << 16), A += 3;
      }
    return _;
  }, Dn;
}
...
function Ki() {
  ...
  class A extends E {
    ...
    start(i, I) {
      ...
      return I.writePacket(u.toPacket(1)), A.prototype.binlogData;
    }
    binlogData(i) {
      if (i.isEOF())
        return this.emit("eof"), null;
      i.readInt8();
      const I = new _(i), u = e[I.eventType];
      let O;
      return u ? O = new u(i) : O = {
        name: "UNKNOWN"
      }, O.header = I, this.emit("event", O), A.prototype.binlogData;
    }
  }
  class T {
    constructor(i) {
  ...
  return e[2] = n, e[4] = T, e[15] = a, e[16] = N, Sn = A, Sn;
}
var Bn, vA;
function ji() {
  if (vA) return Bn;
  vA = 1;
  const E = AE(), t = eE(), e = uE(), _ = HR(), A = IE();
  class T extends E {
    constructor(n, N) {
    ...
    start(n, N) {
      ...
      return this.currentConfig.user = this.user, this.currentConfig.password = this.password, this.currentConfig.database = this.database, this.currentConfig.charsetNumber = this.charsetNumber, N.clientEncoding = A[this.charsetNumber], N._statements.clear(), N.writePacket(R.toPacket()), N.serverCapabilityFlags & e.MULTI_FACTOR_AUTHENTICATION && (this.authenticationFactor = 1), T.prototype.handshakeResult;
    }
  }
...
function ki() {
  ...
  class _ extends E {
    ...
    start(T, a) {
      ...
      return this.onResult && this.onResult(), a.writePacket(n), null;
    }
  }
  return ln = _, ln;
}
...
function Ji() {
  if (XA) return Mn;
  XA = 1;
  const E = HR(), t = Qi(), e = yR(), _ = Hi(), A = XR(), T = KR(), a = vi(), n = yi(), N = Ki(), R = ji(), i = ki();
  return Mn = {
    ClientHandshake: E,
    ServerHandshake: t,
    Query: e,
...
function $n() {
  if (zA) return Ln;
  zA = 1;
  const { URL: E } = ot, t = uE(), e = hE(), { version: _ } = Zi;
  let A = null;
  const T = {
    authPlugins: 1,
    authSwitchHandler: 1,
  ...
  class a {
    constructor(N) {
      ...
      this.maxPacketSize = 0, this.charsetNumber = N.charset ? a.getCharsetNumber(N.charset) : N.charsetNumber || e.UTF8MB4_UNICODE_CI, this.compress = N.compress || !1, this.authPlugins = N.authPlugins, this.authSwitchHandler = N.authSwitchHandler, this.clientFlags = a.mergeFlags(
        a.getDefaultFlags(N),
        N.flags || ""
      );
      const R = {
    ...
    static mergeFlags(N, R) {
      let i = 0, I;
      Array.isArray(R) || (R = String(R || "").toUpperCase().split(/\s*,+\s*/));
      for (I in N)
        R.indexOf(`-${N[I]}`) >= 0 || (i |= t[N[I]] || 0);
      for (I in R)
        R[I][0] !== "-" && (N.indexOf(R[I]) >= 0 || (i |= t[R[I]] || 0));
      return i;
    }
    static getDefaultFlags(N) {
      ...
      return N && N.multipleStatements && R.push("MULTI_STATEMENTS"), R.push("PLUGIN_AUTH"), R.push("PLUGIN_AUTH_LENENC_CLIENT_DATA"), R;
    }
    static getCharsetNumber(N) {
      const R = e[N.toUpperCase()];
      if (R === void 0)
    ...
    static parseUrl(N) {
      const R = new E(N), i = {
        host: decodeURIComponent(R.hostname),
        port: parseInt(R.port, 10),
        database: decodeURIComponent(R.pathname.slice(1)),
        user: decodeURIComponent(R.username),
        password: decodeURIComponent(R.password)
      };
      return R.searchParams.forEach((I, u) => {
        try {
          i[u] = JSON.parse(I);
        } catch {
          i[u] = I;
...
function _I() {
  ...
  ZA = 1;
  const E = /(?:\?)|(?::(\d+|(?:[a-zA-Z][a-zA-Z0-9_]*)))/g, t = 34, e = 39, _ = 92;
  function A(n) {
    let N = E.exec(n), R = 0, i = 0, I;
    const u = [];
    let O = !1, S = !1, c;
    const s = [];
    let r = 0, C = 0, D;
    if (N) {
      do {
        for (D = R, I = N.index; D < I; ++D) {
          const B = n.charCodeAt(D);
          if (B === _) S = !S;
          else {
            if (S) {
              S = !1;
            ...
            if (O && B === c) {
              if (n.charCodeAt(D + 1) === c) {
                ++D;
                continue;
              }
              O = !1;
            } else !O && (B === t || B === e) && (O = !0, c = B);
          }
        }
        O || (u.push(n.substring(i, I)), s.push(N[0].length === 1 ? r++ : N[1]), i = I + N[0].length, C = i), R = I + N[0].length;
      } while (N = E.exec(n));
      if (s.length)
        return R < n.length && u.push(n.substring(C)), [u, s];
    }
    return [n];
  }
  function T(n) {
    ...
    let N = 100, R;
    typeof n.cache == "number" && (N = n.cache), typeof n.cache == "object" && (R = n.cache), n.cache !== !1 && !R && (R = ZE().createLRU({ max: N }));
    function i(S, c) {
      const s = [];
      if (S.length === 1)
        return [S[0], []];
    ...
    function u(S) {
      ...
      for (let r = 1; r < S[0].length; ++r)
        S[0][r - 1].slice(-1) === ":" && (c += n.placeholder), c += n.placeholder, c += I(S[0][r]);
      const s = S[0][S[0].length - 1];
      return S[0].length === S[1].length && (s.slice(-1) === ":" && (c += n.placeholder), c += n.placeholder), [c, S[1]];
    }
    function O(S, c) {
      let s;
      return R && (s = R.get(S)) || (s = u(A(S)), R && R.set(S, s)), i(s, c);
    }
    return O.parse = A, O;
  }
  function a(n, N) {
    ...
    for (let s = 0; s < R[0].length; ++s)
      S = I[R[1][s]], S || (S = ++u, I[R[1][s]] = S), R[1][s] ? (c[S - 1] = R[1][s], O += `${R[0][s]}$${S}`) : O += R[0][s];
...
function xE() {
  if (qA) return on;
  qA = 1;
  const E = Mt, t = wR, e = Zn, _ = aE.EventEmitter, A = GR.Readable, T = VR(), a = qn(), { createLRU: n } = ZE(), N = YR(), R = eE(), i = Ji(), I = $n(), u = IE();
  let O = 0, S = null;
  class c extends _ {
    constructor(r) {
      super(), this.config = r.config, r.config.stream ? typeof r.config.stream == "function" ? this.stream = r.config.stream(r) : this.stream = r.config.stream : r.config.socketPath ? this.stream = E.connect(r.config.socketPath) : (this.stream = E.connect(r.config.port, r.config.host), this.config.enableKeepAlive && this.stream.on("connect", () => {
      ...
      }), this.stream.setNoDelay(!0)), this._internalId = O++, this._commands = new T(), this._command = null, this._paused = !1, this._paused_packets = new T(), this._statements = n({
        ...
        this.connectTimeout && (e.clearTimeout(this.connectTimeout), this.connectTimeout = null), this.packetParser.execute(D);
      }), this.stream.on("end", () => {
        this.emit("end");
    ...
    // ===================================
    writeColumns(r) {
      this.writePacket(R.ResultSetHeader.toPacket(r.length)), r.forEach((C) => {
        this.writePacket(
          R.ColumnDefinition.toPacket(C, this.serverConfig.encoding)
        );
      }), this.writeEof();
    }
    ...
    writeTextRow(r) {
      this.writePacket(
        R.TextRow.toPacket(r, this.serverConfig.encoding)
      );
    }
    writeBinaryRow(r) {
      this.writePacket(
        R.BinaryRow.toPacket(r, this.serverConfig.encoding)
      );
    }
    ...
    writeEof(r, C) {
      this.writePacket(R.EOF.toPacket(r, C));
    }
    writeOk(r) {
      r || (r = { affectedRows: 0 }), this.writePacket(R.OK.toPacket(r, this.serverConfig.encoding));
    }
    writeError(r) {
      const C = this.serverConfig ? this.serverConfig.encoding : "cesu8";
      this.writePacket(R.Error.toPacket(r, C));
    }
    serverHandshake(r) {
...
function GE() {
  ...
  function E(t, e, _) {
    return function(A, T, a) {
      A ? (_.message = A.message, _.code = A.code, _.errno = A.errno, _.sql = A.sql, _.sqlState = A.sqlState, _.sqlMessage = A.sqlMessage, e(_)) : t([T, a]);
    };
  }
  return gn = E, gn;
}
...
function nI() {
  ...
  class t {
    ...
    execute(_) {
      ...
      return new this.Promise((a, n) => {
        const N = E(a, n, T);
        _ ? A.execute(_, N) : A.execute(N);
      });
    }
    close() {
...
function Ee() {
  ...
  function E(t, e, _) {
    const A = {};
    e.on("newListener", (T) => {
      _.indexOf(T) >= 0 && !e.listenerCount(T) && t.on(
        T,
        A[T] = function() {
          const a = [].slice.call(arguments);
          a.unshift(T), e.emit.apply(e, a);
        }
      );
    }).on("removeListener", (T) => {
      _.indexOf(T) >= 0 && !e.listenerCount(T) && (t.removeListener(T, A[T]), delete A[T]);
    });
  }
  return dn = E, dn;
}
...
function _e() {
  if (_R) return wn;
  _R = 1;
  const E = aE.EventEmitter, t = nI(), e = GE(), _ = Ee(), A = xE();
  class T extends E {
    constructor(n, N) {
    ...
    query(n, N) {
      ...
      return new this.Promise((I, u) => {
        const O = e(I, u, i);
        N !== void 0 ? R.query(n, N, O) : R.query(n, O);
      });
    }
    execute(n, N) {
      const R = this.connection, i = new Error();
      ...
      return new this.Promise((I, u) => {
        const O = e(I, u, i);
        N !== void 0 ? R.execute(n, N, O) : R.execute(n, O);
      });
    }
    end() {
    ...
    ping() {
      ...
      return new this.Promise((R, i) => {
        n.ping((I) => {
          I ? (N.message = I.message, N.code = I.code, N.errno = I.errno, N.sqlState = I.sqlState, N.sqlMessage = I.sqlMessage, i(N)) : R(!0);
        });
      });
    }
    connect() {
      ...
      return new this.Promise((R, i) => {
        n.connect((I, u) => {
          I ? (N.message = I.message, N.code = I.code, N.errno = I.errno, N.sqlState = I.sqlState, N.sqlMessage = I.sqlMessage, i(N)) : R(u);
        });
      });
    }
    prepare(n) {
      const N = this.connection, R = this.Promise, i = new Error();
      return new this.Promise((I, u) => {
        N.prepare(n, (O, S) => {
          if (O)
    ...
    changeUser(n) {
      const N = this.connection, R = new Error();
      return new this.Promise((i, I) => {
        N.changeUser(n, (u) => {
          u ? (R.message = u.message, R.code = u.code, R.errno = u.errno, R.sqlState = u.sqlState, R.sqlMessage = u.sqlMessage, I(R)) : i();
        });
      });
    }
    get config() {
  ...
  return (function(a) {
    for (let n = 0; a && n < a.length; n++) {
      const N = a[n];
      typeof A.prototype[N] == "function" && T.prototype[N] === void 0 && (T.prototype[N] = /* @__PURE__ */ (function(i) {
        return function() {
          return A.prototype[i].apply(
            this.connection,
            arguments
          );
        };
...
function kR() {
  if (AR) return Qn;
  AR = 1;
  const E = zE, t = qn(), e = aE.EventEmitter, _ = eI(), A = VR(), T = xE();
  function a(N, R) {
    const i = N.length;
    for (let I = 0; I < i; I++)
      if (N.get(I) === R) {
  ...
  class n extends e {
    constructor(R) {
      super(), this.config = R.config, this.config.connectionConfig.pool = this, this._allConnections = new A(), this._freeConnections = new A(), this._connectionQueue = new A(), this._closed = !1, this.config.maxIdle < this.config.connectionLimit && this._removeIdleTimeoutConnections();
    }
    getConnection(R) {
      if (this._closed)
        return E.nextTick(() => R(new Error("Pool is closed.")));
      let i;
      return this._freeConnections.length > 0 ? (i = this._freeConnections.pop(), this.emit("acquire", i), E.nextTick(() => R(null, i))) : this.config.connectionLimit === 0 || this._allConnections.length < this.config.connectionLimit ? (i = new _(this, {
        config: this.config.connectionConfig
      }), this._allConnections.push(i), i.connect((I) => this._closed ? R(new Error("Pool is closed.")) : I ? R(I) : (this.emit("connection", i), this.emit("acquire", i), R(null, i)))) : this.config.waitForConnections ? this.config.queueLimit && this._connectionQueue.length >= this.config.queueLimit ? R(new Error("Queue limit reached.")) : (this.emit("enqueue"), this._connectionQueue.push(R)) : E.nextTick(() => R(new Error("No connections available.")));
    }
    releaseConnection(R) {
      let i;
      R._pool ? this._connectionQueue.length ? (i = this._connectionQueue.shift(), E.nextTick(i.bind(null, null, R))) : (this._freeConnections.push(R), this.emit("release", R)) : this._connectionQueue.length && (i = this._connectionQueue.shift(), E.nextTick(this.getConnection.bind(this, i)));
    }
    end(R) {
      this._closed = !0, clearTimeout(this._removeIdleTimeoutConnectionsTimer), typeof R != "function" && (R = function(S) {
        if (S)
          throw S;
      });
      let i = !1, I = 0, u;
    ...
    _removeConnection(R) {
      a(this._allConnections, R), a(this._freeConnections, R), this.releaseConnection(R);
    }
...
function JR() {
  if (RR) return Pn;
  RR = 1;
  const E = aE.EventEmitter, t = GE(), e = $E(), _ = Ee(), A = kR();
  class T extends E {
    constructor(n, N) {
    ...
    execute(n, N) {
      ...
      return new this.Promise((I, u) => {
        const O = t(I, u, i);
        N ? R.execute(n, N, O) : R.execute(n, O);
      });
    }
    end() {
      ...
      return new this.Promise((R, i) => {
        n.end((I) => {
          I ? (N.message = I.message, N.code = I.code, N.errno = I.errno, N.sqlState = I.sqlState, N.sqlMessage = I.sqlMessage, i(N)) : R();
        });
      });
    }
  }
  return (function(a) {
    for (let n = 0; a && n < a.length; n++) {
      ...
      typeof A.prototype[N] == "function" && T.prototype[N] === void 0 && (T.prototype[N] = /* @__PURE__ */ (function(i) {
        return function() {
          return A.prototype[i].apply(this.pool, arguments);
        };
      })(N));
    }
  })([
...
function pR() {
  if (NR) return Yn;
  NR = 1;
  const E = zE, t = zR(), e = ZR(), _ = qR(), A = aE.EventEmitter, T = {
    RR() {
      let i = 0;
  ...
  class e {
    ...
    getConnection() {
      ...
      return new this.Promise((T, a) => {
        A.getConnection((n, N) => {
          n ? a(n) : T(new E(N, this.Promise));
        });
      });
    }
    query(A, T) {
      const a = this.poolNamespace, n = new Error();
...
function II() {
  return cR || (cR = 1, (function(E) {
    const t = qn(), e = aE.EventEmitter, _ = pn(), A = pR(), T = AI(), a = RI(), n = tI(), N = _e(), R = JR(), i = GE(), I = $E(), u = Ee(), O = iI();
    function S(C) {
    ...
    (function(C) {
      for (let D = 0; C && D < C.length; D++) {
        const B = C[D];
        typeof A.prototype[B] == "function" && s.prototype[B] === void 0 && (s.prototype[B] = /* @__PURE__ */ (function(h) {
          return function() {
            return A.prototype[h].apply(
              this.poolCluster,
              arguments
            );
          };
    ...
    function r(C) {
      const D = n(C), B = C && C.Promise || Promise;
      if (!B)
        throw new Error(
          "no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }"
        );
    ...
    E.createConnection = S, E.createPool = c, E.createPoolCluster = r, E.escape = t.escape, E.escapeId = t.escapeId, E.format = t.format, E.raw = t.raw, E.PromisePool = R, E.PromiseConnection = N, E.PromisePoolConnection = I, E.__defineGetter__("Types", () => TE()), E.__defineGetter__(
      "Charsets",
      () => hE()
    ), E.__defineGetter__(
      "CharsetToEncoding",
...
function rI() {
  if (!XE) {
    const E = process.env.MYSQL_PORT ? Number(process.env.MYSQL_PORT) : 3306, t = (process.env.MYSQL_SSL || "").toLowerCase(), e = t === "1" || t === "true" || t === "yes", _ = (process.env.MYSQL_SSL_REJECT_UNAUTHORIZED || "").toLowerCase(), A = !(_ === "0" || _ === "false" || _ === "no");
    XE = TI.createPool({
      ...
      ssl: e ? { rejectUnauthorized: A } : void 0,
...
async function sI(E) {
  const t = new Date(E).toISOString().split("T")[0], e = await V(async (_) => {
    const [A] = await _.execute(
      `
        SELECT h.hora
        FROM horarios_base h
  ...
  if (e.ok) {
    let _ = e.value;
    return xR(E) && (_ = _.filter((A) => A.hora < "12:00")), _;
  }
  return OI(t);
}
function OR(E) {
...
function DR(E, t, e) {
  console.log("[Service] Bloqueando horario:", { fecha: E, hora: t, motivo: e });
  const _ = Q(), A = new Date(E).toISOString().split("T")[0], T = LE(t);
  console.log("[Service] Fecha normalizada:", E, "->", A), console.log("[Service] Hora normalizada:", t, "->", T);
  try {
    _.transaction(() => {
      if (_.prepare(`
      ...
      _.prepare(`
        ...
        VALUES ( ?, ?, ?)
      `).run(A, T, e ?? ""), console.log("[Service] Horario bloqueado");
    })();
  } catch (a) {
    throw console.error("[Service] Error en bloquearHorario:", a), a;
  }
}
async function MI(E, t, e) {
  console.log("[Service] Bloqueando horario:", { fecha: E, hora: t, motivo: e });
  const _ = new Date(E).toISOString().split("T")[0], A = LE(t);
  if ((await V(async (a) => {
    const [n] = await a.execute(
      "SELECT id FROM bloqueos_horarios WHERE fecha = ? AND hora = ?",
      [_, A]
    );
    n.length || await a.execute(
...
function SR(E, t) {
  ...
  const e = Q(), _ = new Date(E).toISOString().split("T")[0], A = LE(t);
  console.log("[Service] Fecha normalizada:", E, "->", _), console.log("[Service] Hora normalizada:", t, "->", A);
  try {
    e.transaction(() => {
      e.prepare(`
...
async function hI(E, t) {
  console.log("[Service] Desbloqueando horario:", { fecha: E, hora: t });
  const e = new Date(E).toISOString().split("T")[0], _ = LE(t);
  if ((await V(async (T) => {
    await T.execute(
...
function LI(E) {
  ...
  const t = Q(), e = new Date(E).toISOString().split("T")[0];
  ...
  const A = t.prepare("SELECT * FROM bloqueos_horarios ORDER BY fecha, hora").all();
...
async function j(E) {
  return new Promise((t, e) => {
    const _ = `op_${++gI}`, A = Date.now();
    sE.push({ id: _, fn: E, resolve: t, reject: e, createdAt: A }), console.log(`[Lock] ${_} encolada. Cola: ${sE.length} operaciones. Locked: ${KE}`), $R();
  });
}
async function $R() {
  if (KE) {
  ...
  KE = !0;
  const E = sE.shift(), e = Date.now() - E.createdAt;
  console.log(`[Lock] INICIANDO ${E.id} (esperó ${e}ms). Quedan: ${sE.length}`);
  try {
    const _ = E.fn();
...
function QI(E) {
  const t = E.tipo_turno, e = /^\d+$/.test(String(E.km || "").trim());
  if (t === "Particular") {
...
async function VI(E) {
  console.log("[Service] Iniciando crearReserva..."), GI(E), QI(E);
  const t = FI({ ...E }), e = new Date(t.fecha).toISOString().split("T")[0];
  console.log("[Service] Fecha normalizada:", t.fecha, "->", e);
  try {
    const _ = await PI(t, e);
    try {
      await hR(t, e);
    } catch (A) {
    ...
    return console.warn("[Service] MySQL no disponible, usando SQLite local"), await hR(t, e);
  }
}
async function Xn(E) {
...
async function bI(E) {
  ...
  try {
    e.transaction(() => {
      const A = e.prepare("SELECT * FROM reservas WHERE id = ?").get(E);
      if (!A) {
...
async function mI(E, t, e) {
  if (console.log("[Service] Moviendo reserva:", { id: E, nuevaFecha: t, nuevaHora: e }), (await V(async (T) => {
    ...
    try {
      const T = Q();
      T.transaction(() => {
        const n = T.prepare("SELECT fecha, hora FROM reservas WHERE id = ?").get(E);
        n && (T.prepare("UPDATE reservas SET fecha = ?, hora = COALESCE( ?, hora) WHERE id = ?").run(t, e ?? null, E), t !== n.fecha && T.prepare(`
            INSERT INTO historial_reservas
            (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
            VALUES ( ?, 'fecha', ?, ?, datetime('now'))
          `).run(E, n.fecha, t), e && e !== n.hora && T.prepare(`
            INSERT INTO historial_reservas
            (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
  ...
  try {
    A.transaction(() => {
      const a = A.prepare("SELECT fecha, hora FROM reservas WHERE id = ?").get(E);
      if (!a) {
        console.log("[Service] Reserva no encontrada para mover:", E);
        return;
      }
      A.prepare("UPDATE reservas SET fecha = ?, hora = COALESCE( ?, hora) WHERE id = ?").run(t, e ?? null, E), t !== a.fecha && A.prepare(`
          INSERT INTO historial_reservas
          (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
          VALUES ( ?, 'fecha', ?, ?, datetime('now'))
        `).run(E, a.fecha, t), e && e !== a.hora && A.prepare(`
          INSERT INTO historial_reservas
          (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
          VALUES ( ?, 'hora', ?, ?, datetime('now'))
        `).run(E, a.hora, e);
...
async function YI(E, t) {
  if (console.log("[Service] Actualizando reserva:", E, t), (await V(async (A) => {
    ...
    await A.execute(
      ...
      [t.nombre, t.fecha, t.hora, t.estado, t.detalles, t.id]
    );
    for (const n of Object.keys(a))
      a[n] !== t[n] && await A.execute(
        `
            INSERT INTO historial_reservas
            (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
            VALUES ( ?, ?, ?, ?, NOW())
...
function ne(E) {
  if (!(!Array.isArray(E) || E.length === 0))
    try {
      const t = Q(), e = t.prepare("SELECT id FROM reservas WHERE id = ?"), _ = t.prepare(`
...
async function WI(E, t) {
  ...
  const e = new Date(E).toISOString().split("T")[0], _ = new Date(t).toISOString().split("T")[0];
  console.log("[Service] Fechas normalizadas:", e, "a", _);
  const A = await V(async (n) => {
  ...
  return A.ok ? (ne(A.value), A.value) : Q().prepare(`
    SELECT * FROM reservas
    WHERE fecha >= ? AND fecha <= ?
    ORDER BY fecha, hora
  `).all(e, _);
...
async function _t(E) {
  const t = new Date(E).toISOString().split("T")[0], e = await V(async (A) => {
    const [T] = await A.execute(
      `
        SELECT * FROM reservas
        WHERE fecha = ?
...
async function vI(E, t) {
  if (console.log("[Service] Actualizando notas para reserva:", E), (await V(async (A) => {
    const [T] = await A.execute(
      "SELECT notas FROM reservas WHERE id = ?",
      [E]
    ), a = T[0];
    a && (await A.execute("UPDATE reservas SET notas = ? WHERE id = ?", [t, E]), await A.execute(
      `
        INSERT INTO historial_reservas
        (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
        VALUES ( ?, 'notas', ?, ?, NOW())
    ...
    try {
      const A = Q(), T = A.prepare("SELECT notas FROM reservas WHERE id = ?").get(E);
      if (!T) return;
      A.transaction(() => {
        A.prepare("UPDATE reservas SET notas = ? WHERE id = ?").run(t, E), A.prepare(`
          INSERT INTO historial_reservas
          (reserva_id, campo, valor_anterior, valor_nuevo, fecha)
...
const XI = "daily-summary.json", BE = {
  enabled: !1,
  sendTime: "07:30",
  recipients: [],
  lastSentDate: ""
...
function et(E) {
  ...
  const [e, _] = t.split(":").map(Number);
  return !Number.isFinite(e) || !Number.isFinite(_) || e < 0 || e > 23 || _ < 0 || _ > 59 ? BE.sendTime : `${String(e).padStart(2, "0")}:${String(_).padStart(2, "0")}`;
}
function At(E) {
  const t = /* @__PURE__ */ new Set();
  for (const e of E || []) {
    const _ = String(e || "").trim().toLowerCase();
...
function FE() {
  try {
    ...
    if (!z.existsSync(E))
      return { ...BE };
    const t = z.readFileSync(E, "utf-8"), e = JSON.parse(t);
    return !e || typeof e != "object" ? { ...BE } : {
      enabled: !!e.enabled,
      sendTime: et(String(e.sendTime || BE.sendTime)),
      recipients: At(Array.isArray(e.recipients) ? e.recipients : []),
      lastSentDate: String(e.lastSentDate || "")
    };
  } catch (E) {
...
function KI(E) {
  const t = nt(), e = x.dirname(t);
  z.existsSync(e) || z.mkdirSync(e, { recursive: !0 }), z.writeFileSync(t, JSON.stringify(E, null, 2), "utf-8");
}
function JE(E) {
  const t = FE(), e = {
...
function JI() {
  const E = String(process.env.SMTP_HOST || "").trim(), t = String(process.env.SMTP_USER || "").trim(), e = String(process.env.SMTP_PASS || "").trim(), _ = String(process.env.SMTP_FROM || t).trim(), A = jI(), T = kI(A);
  return { host: E, port: A, secure: T, user: t, pass: e, from: _ };
}
function zI(E, t) {
  const e = [
    ...
    const T = A != null && A.hora ? String(A.hora) : "--:--", a = A != null && A.nombre ? String(A.nombre) : "Sin nombre", n = A != null && A.telefono ? String(A.telefono) : "-", N = A != null && A.matricula ? String(A.matricula) : "-", R = A != null && A.estado ? String(A.estado) : "Pendiente";
    return `${T} | ${a} | ${n} | ${N} | ${R}`;
  });
  return _.length === 0 && _.push("Sin reservas para esta fecha."), [...e, ..._].join(`
`);
}
async function Rt(E) {
  const t = FE();
  ...
  const e = JI();
  if (!e.host || !e.user || !e.pass || !e.from)
    return { ok: !1, reason: "smtp_missing" };
  const _ = await _t(E), A = zI(E, _);
  return await (await import("./nodemailer-BWq1Ub4E.js").then((n) => n.n)).createTransport({
    host: e.host,
    port: e.port,
    secure: e.secure,
    auth: {
    ...
    text: A
  }), JE({ lastSentDate: E }), { ok: !0, count: _.length };
}
function ZI(E) {
  const t = /* @__PURE__ */ new Date(), e = String(t.getHours()).padStart(2, "0"), _ = String(t.getMinutes()).padStart(2, "0");
  return `${e}:${_}` === E.sendTime;
}
async function oR() {
  const E = FE();
  if (!E.enabled || !ZI(E)) return;
  const t = jn();
  if (E.lastSentDate !== t)
    try {
      const e = await Rt(t);
      if (!e.ok) {
        console.warn("[ResumenDiario] Envio omitido:", e.reason);
        return;
      }
      console.log(`[ResumenDiario] Correo enviado. Reservas: ${e.count}`);
    } catch (e) {
      console.error("[ResumenDiario] Error enviando resumen diario:", e);
    }
}
function qI() {
...
async function pI(E) {
  const t = String(E || jn()).trim(), e = /^\d{4}-\d{2}-\d{2}$/.test(t) ? t : jn(), _ = FE();
...
function xI() {
  const E = (e, _) => {
    for (const A of UR.getAllWindows())
      A.isDestroyed() || A.webContents.send(e, _);
  }, t = async (e, _, A) => {
    let T = null;
    try {
      T = await Xn(_);
    ...
    } : { id: _, ...A || {} }, n = e === "creada" ? "Nueva reserva" : e === "eliminada" ? "Reserva eliminada" : "Reserva modificada", R = [
...
` + "=".repeat(50)), console.log("[IPC] Recibiendo solicitud de reserva:"), console.log(_), console.log("=".repeat(50)), console.log("[IPC] Esperando lock...");
    const T = await j(async () => (console.log("[IPC] Lock adquirido, ejecutando crearReserva"), await VI(_))), a = Date.now() - A;
...
`), typeof T == "number" && await t("creada", T, {
  ...
  }), m("reservas:obtener", (e, _) => (console.log("[IPC] Obteniendo reserva:", _), Xn(_))), m("reservas:borrar", async (e, _) => {
  ...
  }), m("reservas:actualizar-notas", async (e, _, A) => {
    console.log("[IPC] Actualizando notas para reserva:", _);
    const T = await j(() => vI(_, A));
    return console.log("[IPC] Notas actualizadas exitosamente"), _ && await t("modificada", _), T;
  }), m("reservas:cambios", async (e, _) => {
    const A = (_ == null ? void 0 : _.since) || (/* @__PURE__ */ new Date(0)).toISOString(), T = Number((_ == null ? void 0 : _.lastId) || 0), a = Number((_ == null ? void 0 : _.limit) || 200);
    return yI(A, T, a);
  }), m("reservas:dia", async (e, _) => {
    const A = String((_ == null ? void 0 : _.fecha) || "").trim();
    return A ? j(() => _t(A)) : [];
  }), m("resumen-diario:config:get", async () => FE()), m("resumen-diario:config:set", async (e, _) => JE({
  ...
  })), m("resumen-diario:enviar", async (e, _) => {
    const A = String((_ == null ? void 0 : _.fecha) || "").trim();
    return pI(A);
  });
}
...
function tt(E, t, e) {
  return E === "creación" ? "Reserva creada" : E === "eliminación" ? "Reserva eliminada" : t === null && e !== null ? `Se estableció ${vE(E)}: ${e}` : t !== null && e === null ? `Se eliminó ${vE(E)}` : t !== e ? `Cambió ${vE(E)} de "${t}" a "${e}"` : `Actualización de ${vE(E)}`;
}
function $I(E) {
...
function iN() {
  m("vehiculos:todos", async () => await j(() => AN())), m("vehiculos:historial", async (E, t) => await j(() => tN(t))), m("vehiculos:mysql-by-matricula", async (E, t) => await j(() => RN(t)));
}
const IN = "mysql.env", NN = [
  "MYSQL_HOST",
  "MYSQL_PORT",
  "MYSQL_USER",
  "MYSQL_PASSWORD",
...
function TN(E) {
  ...
  for (const _ of e) {
    ...
    const T = A.indexOf("=");
    if (T === -1) continue;
    const a = A.slice(0, T).trim();
    let n = A.slice(T + 1).trim();
    (n.startsWith('"') && n.endsWith('"') || n.startsWith("'") && n.endsWith("'")) && (n = n.slice(1, -1)), a && (t[a] = n);
  }
  return t;
}
function aN() {
...
function it() {
  ...
  const t = z.readFileSync(E, "utf-8"), e = TN(t);
...
function It(E) {
  const t = ee(), e = x.dirname(t);
  z.existsSync(e) || z.mkdirSync(e, { recursive: !0 }), z.writeFileSync(t, E, "utf-8");
}
function uN() {
  m("config:env:get", async () => rN()), m("config:env:set", async (E, t) => (It(t || ""), it(), uI(), { ok: !0 })), m("config:db:test", async () => {
    const E = await V(async (t) => {
      const [e] = await t.query("SELECT 1 as ok");
      return e;
    });
...
function Ae(E) {
  const t = kE.randomBytes(16), e = kE.scryptSync(E, t, 32);
  return `scrypt$${t.toString("hex")}$${e.toString("hex")}`;
}
function ON(E, t) {
  const e = t.split("$");
  if (e.length !== 3 || e[0] !== "scrypt") return !1;
  const _ = Buffer.from(e[1], "hex"), A = Buffer.from(e[2], "hex"), T = kE.scryptSync(E, _, 32);
  return kE.timingSafeEqual(A, T);
}
function PE(E, t) {
  const e = nE(E), _ = new Set(kn);
  if (!t || t.length === 0)
    return lE(e);
...
function Jn(E, t) {
  ...
  try {
    ...
    return Array.isArray(_) ? PE(e, _) : lE(e);
  } catch {
    return lE(e);
  }
}
async function Tt(E) {
  await cE();
  const t = JSON.stringify(PE(E.role, E.permissions)), e = E.activo ?? 1;
  return V(async (_) => (await _.query(
    ...
    [E.nombre, E.username, E.passwordHash, E.role, t, e]
  ), !0));
}
function zn(E) {
  const t = Q(), e = JSON.stringify(PE(E.role, E.permissions)), _ = E.activo ?? 1;
  t.prepare(
    `INSERT INTO usuarios (nombre, username, password_hash, role, permissions_json, activo)
     VALUES ( ?, ?, ?, ?, ?, ?)
...
async function at() {
  const E = process.env.SUPERADMIN_USER || "superadmin", t = process.env.SUPERADMIN_PASS || "rodrigoSayasDev724", e = process.env.SUPERADMIN_NAME || "", _ = "superadmin", A = lE(_), T = Ae(t);
  await cE();
...
async function DN(E, t) {
  ...
  return e.ok ? _ = e.value : _ = Q().prepare(
    "SELECT id, nombre, username, password_hash, role, permissions_json, activo FROM usuarios WHERE username = ? LIMIT 1"
  ).get(E), !_ || !_.password_hash ? { ok: !1, error: "Usuario o contraseña inválida" } : _.activo ? ON(t, _.password_hash) ? (await QE({
...
async function SN(E) {
  await cE();
  const t = nE(E.role), e = PE(t, E.permissions), _ = Ae(E.password);
  if (!(await Tt({
    nombre: E.nombre,
    username: E.username,
    passwordHash: _,
...
async function BN(E) {
  await cE();
  const t = nE(E.role), e = PE(t, E.permissions), _ = await V(async (T) => (await T.query(
    `UPDATE usuarios SET nombre = ?, username = ?, role = ?, permissions_json = ?, activo = ?
       WHERE id = ?`,
    [E.nombre, E.username, t, JSON.stringify(e), E.activo ?? 1, E.id]
  ), !0));
  Q().prepare(
    `UPDATE usuarios SET nombre = ?, username = ?, role = ?, permissions_json = ?, activo = ?
     WHERE id = ?`
  ).run(E.nombre, E.username, t, JSON.stringify(e), E.activo ?? 1, E.id), _.ok || console.warn("[Usuarios] MySQL no disponible, actualizado solo en SQLite"), await QE({
    actor_username: E.actor_username || "sistema",
    actor_role: E.actor_role || "system",
...
async function lN(E, t) {
  const e = await ut(E);
  await cE(), await V(async (A) => (await A.query("DELETE FROM usuarios WHERE id = ?", [E]), !0)), Q().prepare("DELETE FROM usuarios WHERE id = ?").run(E), await QE({
...
async function MN(E, t, e) {
  const _ = await ut(E);
  await cE();
  const A = Ae(t);
  await V(async (a) => (await a.query("UPDATE usuarios SET password_hash = ? WHERE id = ?", [A, E]), !0)), Q().prepare("UPDATE usuarios SET password_hash = ? WHERE id = ?").run(A, E), await QE({
...
function hN() {
  tE.handle("usuarios:bootstrap", async () => (await at(), { ok: !0 })), tE.handle("usuarios:login-list", async () => CN()), tE.handle("auth:login", async (E, t, e) => DN(t, e)), tE.handle("usuarios:list", async () => rt()), tE.handle("usuarios:create", async (E, t) => {
    try {
      return await SN(t), { ok: !0 };
    } catch (e) {
      return { ok: !1, error: e.message || "Error al crear usuario" };
    }
  }), tE.handle("usuarios:update", async (E, t) => {
    try {
      return await BN(t), { ok: !0 };
    } catch (e) {
      return { ok: !1, error: e.message || "Error al actualizar usuario" };
    }
  }), tE.handle("usuarios:delete", async (E, t) => {
    try {
      return await lN(t.id, t.actor), { ok: !0 };
    } catch (e) {
      return { ok: !1, error: e.message || "Error al eliminar usuario" };
    }
  }), tE.handle("usuarios:password", async (E, t) => {
    try {
      return await MN(t.id, t.password, t.actor), { ok: !0 };
    } catch (e) {
...
function LN() {
  m("auditoria:list", async () => cN());
}
function oN() {
  console.log(` 
 Cargando IPC handlers  
`), UI(), xI(), nN(), iN(), uN(), hN(), LN(), console.log(` 
...
function UN() {
  const E = /* @__PURE__ */ new Date(), t = (e) => String(e).padStart(2, "0");
...
function gR() {
  try {
    ...
    const e = x.join(t, `reservas_${UN()}.db`);
    z.copyFileSync(E, e), console.log("[Backup] Copia creada:", e);
  } catch (E) {
...
const jE = process.env.VITE_DEV_SERVER_URL, wN = x.join(process.env.APP_ROOT, "dist-electron"), st = x.join(process.env.APP_ROOT, "dist");
...
CE.whenReady().then(async () => {
  it(), Q(), await at(), oN(), dN(), qI(), GN(), tE.on("settings:update", (E, t) => {
    if (!t || typeof t != "object") return;
    const e = t.soundEnabled, _ = t.theme;
    dI({
